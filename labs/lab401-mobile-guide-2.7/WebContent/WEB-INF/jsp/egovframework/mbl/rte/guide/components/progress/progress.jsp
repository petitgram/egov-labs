            ...
            <div data-role="content" data-theme="d">
                ...
                <div class="content-primary">
					...
					<div class="egov-deth1">
						...
						<p> <strong>hidePageLoadingMsg() </strong></p>
						<p>$.mobile.loadingMessage.를 통해 설정 된 loader 메세지를 숨긴다. </p>
						<div class="egov-deth2">
					 		<ul class="link">					 			
					 			<li class="egov-txtIn1">$.mobile.hidePageLoadingMsg();</li>
					 		</ul>
						</div>
						...
						<p> <strong>showPageLoadingMsg() </strong></p>
						<p>Page loading 메세지를 출력한다.</p>
						<div class="egov-deth2">
					 		<ul class="link">					 			
					 			<li class="egov-txtIn1">$.mobile.showPageLoadingMsg();</li>					 			
					 			<li class="egov-txtIn1">$.mobile.showPageLoadingMsg( "b", "This is only a test", true );</li>
					 		</ul>
						</div>
