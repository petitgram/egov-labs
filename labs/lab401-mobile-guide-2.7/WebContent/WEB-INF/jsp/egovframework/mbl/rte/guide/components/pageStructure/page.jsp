    ...
    <body>
        ...
        <div data-role="page" class="type-index">
                    ...
                    <div class="egov-deth1">
                        ...
                        <div class="egov-deth2">
                            <ul class="link">
                                ...
                                <li class="egov-txtIn2"><strong>&lt;link rel="stylesheet" href="/css/egovframework/mbl/cmm/jquery.mobile-1.3.2.css"/&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;link rel="stylesheet" href="/css/egovframework/mbl/cmm/EgovMobile-1.3.2.css" /&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;script src="/js/egovframework/mbl/cmm/jquery-1.9.1.min.js"&gt;&lt;/script&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;script src="/js/egovframework/mbl/cmm/jquery.mobile-1.3.2.js"&gt;&lt;/script&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;script src="/js/egovframework/mbl/cmm/EgovMobile-1.3.2.js"&gt;&lt;/script&gt;</strong></li>
                                <li class="egov-txtIn1">&lt;/head&gt;</li>
            ...
            <div data-role="footer" data-theme="z"  class="egovBar">
                 <h4 class="main">Copyright(c)2012 Ministry of Security and Public Administration.</h4>
            </div>
            <!-- footer end --> 
