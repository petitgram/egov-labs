...
<html>
    <head>
        <title>UX Component Tutor</title>
        <!--
    ...
    <body>
        ...
        <div data-role="page" data-theme="d" id="main">
            ...
            <div data-role="content" id="main">
                ...
                ** TODO [Step 3-01]	
					...
					새창에서 열기 : target="home"
                --> 
                <a href="http://m.egovframe.go.kr/mguide/guide/guide.do" data-role="button" data-theme="f" data-corners="false" data-icon="star" target="home">Button</a>
                ...
                ** TODO [Step 3-02]
                ...
                -->
                <a href="/internalLinkPage.jsp" data-role="button" data-theme="e" data-ajax="false">도메인 내부 링크</a>
                ...
                ** TODO [Step 3-03]
                ...
                -->
                <a href="#sub" data-role="button" data-theme="g" data-rel="dialog" data-transition="pop">페이지 내부 링크</a>
				...
				<form id="form-1" action="#" method="get">
					...
					** TODO [Step 4-01]
					...
					<!--
					** TODO [Step 4-02] <input> Tag 부가설명 추가
					...
					** TODO [Step 5-04]
					...
					<div data-role="fieldcontain">
						...
						<select name="select-choice-1" id="select-choice-1" data-native-menu="false" multiple="multiple">
							...
							<option value="orange" disabled="disabled">Orange</option>
				...
				** TODO [Step 6-02] Date Picker 추가
				...
				<div data-role="fieldcontain">
					...
					<input name="mydate" id="mydate1" type="date" data-role="datebox" data-options='{"mode": "datebox", "themeHeader": "b", "themeButton": "e"}'/>
				</div>
				<!--
				** TODO [Step 6-03] Timne Picker 추가
				...
				<div data-role="fieldcontain">
					...
					<input name="mydate" id="mydate2" type="date" data-role="datebox" data-options='{"mode": "timebox", "overrideTimeOutput": "%l:%M %p", "themeHeader": "b", "themeButton": "e"}'/>
				</div>
		...
		<div data-role="page" data-theme="d" id="sub">
			...
			<a href="#main" data-rel="back">Go Main Page</a>
			</div>
			<!-- content end -->
