...
public class EgovAcceleratoriOSAPIController {
    ...
    public ModelAndView selectAcceleratorInfoXMLList(@ModelAttribute("searchVO") AcceleratoriOSAPIDefaultVO searchVO, 
    		ModelMap model)
            throws Exception {
    	ModelAndView jsonView = new ModelAndView("jsonView"); 
    	
		List<AcceleratoriOSAPIVO> acceleratorInfoList = egovAcceleratoriOSAPIService.selectAcceleratorInfoList(searchVO);
    ...
    public ModelAndView  addAcceleratorInfoXml(
    		@ModelAttribute("searchVO") AcceleratoriOSAPIDefaultVO searchVO,
       	 	AcceleratoriOSAPIVO acceleratorVO,
