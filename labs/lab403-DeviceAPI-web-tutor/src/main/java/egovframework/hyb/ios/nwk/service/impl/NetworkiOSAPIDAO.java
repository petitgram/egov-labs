...
public class NetworkiOSAPIDAO extends EgovAbstractDAO {
    ...
    public NetworkiOSAPIVO selectNetworkInfo(NetworkiOSAPIVO vo) throws Exception {
        return (NetworkiOSAPIVO) selectByPk("networkiOSAPIDAO.selectNetworkInfo", vo);
    }
    ...
    public int selectNetworkInfoListTotCnt(NetworkiOSAPIDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("networkAPIDAO.selectNetworkInfoListTotCnt", searchVO);
    }
