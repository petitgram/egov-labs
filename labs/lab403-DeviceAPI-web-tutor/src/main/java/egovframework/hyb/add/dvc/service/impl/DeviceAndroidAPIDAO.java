...
public class DeviceAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public DeviceAndroidAPIVO selectDeviceInfo(DeviceAndroidAPIVO vo) throws Exception {
        return (DeviceAndroidAPIVO) selectByPk("deviceAndroidAPIDAO.selectDeviceInfo", vo);
    }
    ...
    public int selectDeviceInfoListTotCnt(DeviceAndroidAPIDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("deviceAndroidAPIDAO.selectDeviceInfoListTotCnt", searchVO);
    }
