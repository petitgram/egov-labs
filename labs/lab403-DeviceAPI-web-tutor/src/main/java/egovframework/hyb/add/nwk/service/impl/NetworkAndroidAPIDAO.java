...
public class NetworkAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public NetworkAndroidAPIVO selectNetworkInfo(NetworkAndroidAPIVO vo) throws Exception {
        return (NetworkAndroidAPIVO) selectByPk("networkAndroidAPIDAO.selectNetworkInfo", vo);
    }
    ...
    public int selectNetworkInfoListTotCnt(NetworkAndroidAPIDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("networkAPIDAO.selectNetworkInfoListTotCnt_S", searchVO);
    }
