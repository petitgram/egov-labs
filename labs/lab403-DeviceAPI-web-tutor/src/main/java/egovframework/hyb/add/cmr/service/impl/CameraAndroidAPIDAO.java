...
public class CameraAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public CameraAndroidAPIVO selectCameraPhotoAlbumInfo(CameraAndroidAPIVO vo) throws Exception {
        return (CameraAndroidAPIVO)selectByPk("cameraAndroidAPIDAO.selectCameraPhotoAlbumInfo", vo);
    }
    ...
    public CameraAndroidAPIFileVO selectImageFileInfo(CameraAndroidAPIFileVO vo) throws Exception {
        return (CameraAndroidAPIFileVO)selectByPk("cameraAndroidAPIDAO.selectImageFileInfo", vo);
    }
    ...
    public CameraAndroidAPIFileVO selectPhotoAlbumPhotoSj(CameraAndroidAPIFileVO vo) throws Exception {
        return (CameraAndroidAPIFileVO)selectByPk("cameraAndroidAPIDAO.selectCameraPhotoAlbumPhotoSj", vo);
    }
}
