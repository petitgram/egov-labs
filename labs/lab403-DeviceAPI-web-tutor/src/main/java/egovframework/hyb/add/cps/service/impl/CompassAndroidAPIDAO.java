...
public class CompassAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public CompassAndroidAPIVO selectCompassInfo(CompassAndroidAPIVO vo) throws Exception {
        return (CompassAndroidAPIVO) selectByPk("compassAndroidAPIDAO.selectCompassInfo", vo);
    }
    ...
    public int selectCompassInfoListTotCnt(CompassAndroidAPIDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("compassAndroidAPIDAO.selectCompassInfoListTotCnt", searchVO);
    }
