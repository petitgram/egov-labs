...
public class EgovAcceleratorAndroidAPIController {
    ...
    public @ResponseBody AcceleratorAndroidAPIVOList selectAcceleratorInfoXMLList(@ModelAttribute("searchVO") AcceleratorAndroidAPIDefaultVO searchVO, 
            ModelMap model)
            throws Exception {
 
        List<AcceleratorAndroidAPIVO> acceleratorInfoList = egovAcceleratorAndroidAPIService.selectAcceleratorInfoList(searchVO);
