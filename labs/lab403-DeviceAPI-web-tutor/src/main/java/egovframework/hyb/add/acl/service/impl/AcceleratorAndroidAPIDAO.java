...
public class AcceleratorAndroidAPIDAO extends EgovAbstractDAO {
    ...
    public AcceleratorAndroidAPIVO selectAcceleratorInfo(AcceleratorAndroidAPIVO vo) throws Exception {
        return (AcceleratorAndroidAPIVO) selectByPk("acceleratorAndroidAPIDAO.selectAcceleratorInfo", vo);
    }
    ...
    public int selectAcceleratorInfoListTotCnt(AcceleratorAndroidAPIDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("acceleratorAndroidAPIDAO.selectAcceleratorInfoListTotCnt", searchVO);
    }
