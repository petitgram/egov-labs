...
public class EgovVibratorAndroidAPIController {
    ...
    public @ResponseBody VibratorAndroidAPIXmlVO selectVibratorInfoList(@ModelAttribute("searchVibratorVO") VibratorAndroidAPIDefaultVO searchVO, 
            ModelMap model)
            throws Exception {
 
        List vibratorInfoList = egovVibratorAndroidAPIService.selectVibratorList(searchVO);
    ...
    public @ResponseBody VibratorAndroidAPIXmlVO insertVibratorInfo(
            @ModelAttribute("searchVibratorAndroidVO") VibratorAndroidAPIDefaultVO searchVO,
