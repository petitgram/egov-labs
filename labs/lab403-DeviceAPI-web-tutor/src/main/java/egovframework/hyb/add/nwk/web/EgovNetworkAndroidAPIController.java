...
public class EgovNetworkAndroidAPIController {
    ...
    public @ResponseBody NetworkAndroidAPIXmlVO selectNetworkInfoList(@ModelAttribute("searchNetworkAndroidVO") NetworkAndroidAPIDefaultVO searchNetworkVO, 
            ModelMap model)
            throws Exception {
 
        List networkInfoList = egovNetworkAndroidAPIService.selectNetworkInfoList(searchNetworkVO);
    ...
    public @ResponseBody NetworkAndroidAPIXmlVO selectNetworkInfo(@ModelAttribute("searchNetworkAndroidVO") NetworkAndroidAPIDefaultVO searchNetworkVO, 
    ...
    public @ResponseBody NetworkAndroidAPIXmlVO insertNetworkInfo(
            @ModelAttribute("searchNetworkAndroidVO") NetworkAndroidAPIDefaultVO searchNetworkVO,
                NetworkAndroidAPIVO sampleNetworkVO,
            BindingResult bindingResult, Model model, SessionStatus status) 
    throws Exception {
    ...
    public @ResponseBody NetworkAndroidAPIXmlVO deleteNetworkInfo(
            NetworkAndroidAPIVO sampleVO,
            @ModelAttribute("searchNetworkiOSVO") NetworkAndroidAPIDefaultVO searchVO, SessionStatus status)
            throws Exception {
