...
public class EgovMediaAndroidAPIController {
    ...
    public @ResponseBody boolean fileUpload(@RequestParam("file") MultipartFile file, MediaAndroidAPIVO vo, 
    ...
    public @ResponseBody MediaAndroidAPIXmlVO selectMediaInfoDetail(MediaAndroidAPIVO vo) throws Exception {
    ...
    public @ResponseBody MediaAndroidAPIXmlVO selectMediaInfoList(MediaAndroidAPIVO vo) throws Exception {
        
        List mediaList = egovMediaAndroidAPIService.selectMediaInfoList(vo);
    ...
    public void getImageInf(@RequestParam("sn") String sn, ModelMap model,
