...
public class EgovPKIAndroidAPIController {
    ...
    public @ResponseBody
    PKIAndroidAPIVOList selectPKIInfoListXml(
            @ModelAttribute("searchPKIVO") PKIAndroidAPIDefaultVO searchVO,
            ModelMap model) throws Exception {

        List<PKIAndroidAPIVO> pkiInfoList = egovPKIAPIService
                .selectPKIInfoList(searchVO);
    ...
    public @ResponseBody
    PKIAndroidAPIVO addPKIInfoXml(
            @ModelAttribute("searchVO") PKIAndroidAPIDefaultVO searchVO,
            PKIAndroidAPIVO PKIVO, BindingResult bindingResult, Model model,
