...
public class LoginController2 {
	...
	public String loginProcess(@ModelAttribute("login") LoginCommand loginCommand, BindingResult errors) {
		...
		try {
			...
			log.debug("loginCommand.getId()       : " + loginCommand.getId());
			log.debug("loginCommand.getPassword() : " + loginCommand.getPassword());
			log.debug("loginCommand.loginType()   : " + loginCommand.getLoginType());
