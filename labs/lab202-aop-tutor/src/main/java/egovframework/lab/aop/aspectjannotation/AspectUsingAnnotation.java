...
public class AspectUsingAnnotation {
    ...
    private final Log sysoutLogger = LogFactory.getLog("sysoutLogger");
    ...
    public void afterTargetMethod(JoinPoint thisJoinPoint) {
        sysoutLogger.debug("AspectUsingAnnotation.afterTargetMethod executed.");
    }
    ...
    public void afterReturningTargetMethod(JoinPoint thisJoinPoint,
            Object retVal) {
        sysoutLogger
            .debug("AspectUsingAnnotation.afterReturningTargetMethod executed. return value is ["
                + retVal + "]");
    ...
    public void afterThrowingTargetMethod(JoinPoint thisJoinPoint,
        ...
        sysoutLogger
            .debug("AspectUsingAnnotation.afterThrowingTargetMethod executed.");
    ...
    public Object aroundTargetMethod(ProceedingJoinPoint thisJoinPoint)
            throws Throwable {
        sysoutLogger.debug("AspectUsingAnnotation.aroundTargetMethod start.");
        ...
        sysoutLogger
            .debug("AspectUsingAnnotation.aroundTargetMethod end. Time("
                + (time2 - time1) + ")");
        return retVal;
    }
