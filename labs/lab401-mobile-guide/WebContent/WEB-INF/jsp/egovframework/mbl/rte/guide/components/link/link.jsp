    ...
    <body>
		...
		<div data-role="page" id="One" class="type-index">
            ...
            <div data-role="header" data-position="inline" data-theme="z"  class="egovBarHeader">
                ...
                <h1 class="main"><img src="<c:url value="/images/egovframework/mbl/rte/guide/h1_logo.png" />" /></h1>
            </div>  
            <!-- header end -->
				...
				<div class="content-primary">
			    	...
			    	<div class="egov-deth1">
				    	...
				    	<p>href 속성 값으로  <strong>mailto:[메일주소]</strong>를 추가한후 <strong>cc="[메일주소]"를 통해 참조, bcc="[숨은 참조]", subject="[제목]", body="[내용]"</strong> 을 추가 하면 다양한 형식으로
							메일 연동을 할 수 있다.</p>
				    	<div class="egov-deth2">
				    		<a href="mailto:person@domain.com?cc=person2@domain.com&bcc=persion3@domain.com&subject=Hello&body=Happy%20Birthday!" data-role="button">다중메일링크</a>
				    		<ul class="link">
				    			<li>&lt;a href="mailto:person@domain.com?cc=person2@domain.com&bcc=persion3@domain.com&subject=Hello&body=Happy%20Birthday!"&gt;다중메일링크&lt;/a&gt;</li>
				    		</ul>
				    	</div>				    	
			    	</div>
