...
<html>
    <head>
        ...
        function changeTab() {
            ...
            f.action="<c:url value="/generate/list/listIcon.do"/>";
            f.target="_self";
        ...
        function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/list/listIconGen.do"/>";
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Table / List View <span class="sub">- List Icon</span></h1>
					</div>			
                               ...
                               <li>
                                    ...
                                    <div class="gen-wid2">
	                                    <select name="compType" data-role="none" class="gen-sele" onChange="javascript:changeType(this.value);">
	                                        ...
	                                        <option value="listIcon" selected="selected">List ICon</option>
                    ...
                    <div class="demo">
                        <div id="tabs">                     
                            ...
                            <c:set var="icon_coffee">${pageContext.request.contextPath}/images/egovframework/mbl/rte/guide/components/list/coffee.png</c:set>
                            <c:set var="icon_icecream">${pageContext.request.contextPath}/images/egovframework/mbl/rte/guide/components/list/icecream.png</c:set>                            
                            <c:forEach var="compIndex" begin="1" end="${compCount}">
                                    ...
                                    <ul class="c-attr">
                                        <li>
                                            ...
                                            <div class="gen-wid2"> 
                                                ...
                                                <input type="text" name="compText_${compIndex}" value="<c:out value='${xml.component[compTextName]}' default="ListIcon ${compIndex}" />" data-role="none" class="gen-sele" />
                                            </div>                                            
                                        </li>
                                        <li>
                                            ...
                                            <div class="gen-wid2"> 
			                                    ...
			                                    <select name="compIcon_<c:out value="${compIndex}" />" data-role="none" class="gen-sele">
			                                        <option value="${icon_coffee}" ${(xml.component[compIconName] == icon_coffee) ? 'selected="selected"' : ''}>커피</option>
			                                        <option value="${icon_icecream}" ${(xml.component[compIconName] == icon_icecream) ? 'selected="selected"' : ''}>아이스 크림</option>
			                                    </select>     
			                                </div>                                       
                                        </li>
                                    </ul>                                    
