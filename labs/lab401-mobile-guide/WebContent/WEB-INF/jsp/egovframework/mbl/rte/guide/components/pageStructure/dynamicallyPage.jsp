						...
						<div class="egov-deth2">
							<ul class="link">
							   	<div data-role="controlgroup">		
								    <a href="<c:url value="/guide/components/pageStructure/json/jsonInternal.do"/>" data-role="button" data-ajax="false">내부링크 Dynamic Page Example</a>
								    <a href="<c:url value="/guide/components/pageStructure/json/jsonExternal.do"/>" data-role="button" data-ajax="false">외부링크 Dynamic Page Example</a>
							    </div>
					 		</ul>
					 	</div>					   					   
				    </div>
