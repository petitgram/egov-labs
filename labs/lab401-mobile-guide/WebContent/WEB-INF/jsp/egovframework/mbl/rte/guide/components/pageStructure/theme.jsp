			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
	        		...
	        		<div class="egov-deth1">
						...
						<div class="egov-deth2">
							<div class="ui-bar-<%= dataTheme %>">
								<h4>Panel <%= dataTheme %></h4>
							</div>
							<ul class="link">
								<li>&lt;div class="ui-bar-<%= dataTheme %>"&gt;</li>
						...
						<div class="egov-deth2">
							<div class="ui-grid-a">
								<div class="ui-block-a"><div class="ui-body-<%= dataTheme %>" align="center"><h3>ui-block-a</h3></div></div>
								<div class="ui-block-b"><div class="ui-body-<%= dataTheme %>" align="center"><h3>ui-block-b</h3></div></div>
							</div>	
							<ul class="link">
								<li>&lt;div class="ui-grid-a"&gt;</li>
								<li class="egov-txtIn1">&lt;div class="ui-block-a"&gt;&lt;div class="ui-body-<%= dataTheme %>" align="center"&gt;&lt;h3&gt;ui-block-a&lt;/h3&gt;&lt;/div&gt;&lt;/div&gt;</li>
								<li class="egov-txtIn1">&lt;div class="ui-block-b"&gt;&lt;div class="ui-body-<%= dataTheme %>" align="center"&gt;&lt;h3&gt;ui-block-b&lt;/h3&gt;&lt;/div&gt;&lt;/div&gt;</li>
								<li>&lt;/div&gt;</li>	
							</ul>
						</div>
						...
						<dl class="egov-deth3">	
							<dd class="egovBul">Date / Time Picker</dd>
						</dl>
						<div class="egov-deth2">
                            <div data-role="fieldcontain">
	                            <label for="andate">안드로이드 형태</label>
	                            <input name="mydate" id="andate" type="date" data-role="datebox"  data-options='{"page": "b", "button": "<%= dataTheme %>"}'>
                            </div>
                            <div data-role="fieldcontain">
	                            <label for="caldate">달력 형태</label>
	                            <input name="mydate" id="caldate" type="date" data-role="datebox" data-options='{"mode": "calbox" , "button": "<%= dataTheme %>"}' >
                            </div>						
							<ul class="link">
                                    <li>&lt;div data-role="fieldcontain"></li>
                                     <li class="egov-txtIn1">&lt;label for="andate">안드로이드 형태&lt;/label></li>
                                     <li class="egov-txtIn1">&lt;input name="mydate" id="andate" type="date" data-role="datebox"  data-options='{"page": "a", "button": "<%= dataTheme %>"}'></li>
                                    <li>&lt;/div></li>
                                    <li>&lt;div data-role="fieldcontain"></li>
                                    <li class="egov-txtIn1">&lt;label for="caldate">달력 형태&lt;/label></li>
                                    <li class="egov-txtIn1">&lt;input name="mydate" id="caldate" type="date" data-role="datebox"  data-options='{"mode": "calbox", "button": "<%= dataTheme %>"}'></li>
                                    <li>&lt;/div></li>                                    							
							</ul>
						</div>
						...
						<div class="egov-deth2">
							<div data-role="fieldcontain"> 
			                    <fieldset data-role="controlgroup" data-type="horizontal">
			                        <legend data-theme="<%= dataTheme %>">Check Box :</legend> 
			                        <input type="checkbox" name="checkbox-6" id="checkbox-6" class="custom" /> 
			                        <label for="checkbox-6" data-theme="<%= dataTheme %>">check 1</label> 
			                        <input type="checkbox" name="checkbox-7" id="checkbox-7" class="custom" /> 
			                        <label for="checkbox-7" data-theme="<%= dataTheme %>">check 2</label>             
			                        <input type="checkbox" name="checkbox-8" id="checkbox-8" class="custom" /> 
			                        <label for="checkbox-8" data-theme="<%= dataTheme %>">check 3</label> 
			                    </fieldset> 
			                </div>
							<ul class="link">
								<li>&lt;div data-role="fieldcontain"&gt;</li>
				                <li class="egov-txtIn1">&lt;fieldset data-role="controlgroup" data-type="horizontal"&gt;</li>
				                <li class="egov-txtIn2">&lt;legend data-theme="<%= dataTheme %>"&gt;Check Box :&lt;/legend&gt;</li>
				                <li class="egov-txtIn2">&lt;input type="checkbox" name="checkbox-6" id="checkbox-6" class="custom" /&gt;</li>
				                <li class="egov-txtIn2">&lt;label for="checkbox-6" data-theme="<%= dataTheme %>">check 1&lt;/label&gt;</li>
				                <li class="egov-txtIn2">&lt;input type="checkbox" name="checkbox-7" id="checkbox-7" class="custom" /&gt;</li>
				                <li class="egov-txtIn2">&lt;label for="checkbox-7" data-theme="<%= dataTheme %>">check 2&lt;/label&gt;</li>   
				                <li class="egov-txtIn2">&lt;input type="checkbox" name="checkbox-8" id="checkbox-8" class="custom" /&gt;</li>
				                <li class="egov-txtIn2">&lt;label for="checkbox-8" data-theme="<%= dataTheme %>">check 3&lt;/label&gt;</li>
						...
						<div class="egov-deth2">
							<fieldset data-role="controlgroup">
		                        <legend data-theme="<%= dataTheme %>">Radio Button:</legend>
		                        <input type="radio" name="radio-choice-1" id="radio-choice-1" value="choice-1" checked="checked" />
		                        <label for="radio-choice-1" data-theme="<%= dataTheme %>">radio 1</label>
		                        <input type="radio" name="radio-choice-1" id="radio-choice-2" value="choice-2"  />
		                        <label for="radio-choice-2" data-theme="<%= dataTheme %>">radio 2</label>
		                    </fieldset>
							<ul class="link">
								<li>&lt;fieldset data-role="controlgroup"&gt;</li>
			                    <li class="egov-txtIn1">&lt;legend data-theme="<%= dataTheme %>"&gt;Radio Button:&lt;/legend&gt;</li>
			                    <li class="egov-txtIn1">&lt;input type="radio" name="radio-choice-1" id="radio-choice-1" value="choice-1" checked="checked" /&gt;</li>
			                    <li class="egov-txtIn1">&lt;label for="radio-choice-1" data-theme="<%= dataTheme %>"&gt;radio 1&lt;/label&gt;</li>
			                    <li class="egov-txtIn1">&lt;input type="radio" name="radio-choice-1" id="radio-choice-2" value="choice-2"  /&gt;</li>
			                    <li class="egov-txtIn1">&lt;label for="radio-choice-2" data-theme="<%= dataTheme %>"&gt;radio 2&lt;/label&gt;</li>
			                    <li>&lt;/fieldset&gt;</li>
							</ul>
						</div>
						...
						<div class="egov-deth2">
							<div data-role="fieldcontain">
			                    ...
			                    <select id="switch" data-role="slider" data-theme="<%= dataTheme %>">
							...
							<ul class="link">
				                ...
				                <li class="egov-txtIn1">&lt;select id="switch" data-role="slider" data-theme="<%= dataTheme %>"&gt;</li>
						...
						<div class="egov-deth2">
							<div data-role="collapsible-set">
								<div data-role="collapsible" data-theme="<%= dataTheme %>"> 
									<h3>collapsible 1</h3> 
									<p>collapsible 1 content</p> 
								</div>
								<div data-role="collapsible" data-collapsed="false" data-theme="<%= dataTheme %>"> 
									<h3>collapsible 2</h3> 
							...
							<ul class="link">
								...
								<li class="egov-txtIn1">&lt;div data-role="collapsible" data-theme="<%= dataTheme %>"&gt;</li> 
								<li class="egov-txtIn2">&lt;h3&gt;collapsible 1&lt;/h3&gt;</li>
								<li class="egov-txtIn2">&lt;p&gt;collapsible 1 content&lt;/p&gt;</li> 
								<li class="egov-txtIn1">&lt;/div&gt;</li>
								<li class="egov-txtIn1">&lt;div data-role="collapsible" data-collapsed="false" data-theme="<%= dataTheme %>"&gt;</li> 
