					...
					<div class="egov-deth1">
						...
						<div class="egov-deth2">
							...
							<ul class="link">
					 			...
					 			<li class="egov-txtIn7"><img src="<c:url value="/images/egovframework/mbl/rte/guide/img_arrow1.png" />"/><b>일련번호</b></li>
					 			<li class="egov-txtIn5"><img src="<c:url value="/images/egovframework/mbl/rte/guide/img_arrow2.png" />"/><b>이미지 유형</b> - 타이틀용 이미지</li>
					 			<li class="egov-txtIn2"><img src="<c:url value="/images/egovframework/mbl/rte/guide/img_arrow3.png" />"/><b>서브시스템 BBS</b> - 커뮤니티>게시판</li>
					 		</ul>
						</div>
					</div>
