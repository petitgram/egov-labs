			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					...
					<div class="egov-deth1">
						...
						<div class="egov-deth2">
							<img style="max-width:100%;" src="<c:url value="/images/egovframework/mbl/rte/guide/img_html3.gif" />"/>
						</div>
						...
						<div class="egov-deth2">
							<img style="max-width:100%;" src="<c:url value="/images/egovframework/mbl/rte/guide/img_html4.gif" />"/>
						</div>
						...
						<div class="egov-deth2">
							<img style="max-width:100%;" src="<c:url value="/images/egovframework/mbl/rte/guide/img_html5.gif" />"/>
						</div>
						...
						<div class="egov-deth2">
							<img style="max-width:100%;" src="<c:url value="/images/egovframework/mbl/rte/guide/img_html6.gif" />"/>
						</div>
						...
						<div class="egov-deth2">
							<ul class="egov-noBack">
								<li>사용법은 아래와 같다.</li>
								<li><img style="max-width:100%;" src="<c:url value="/images/egovframework/mbl/rte/guide/img_html7.gif" />"/></li>
							</ul>
						</div>
						...
						<div class="egov-deth2">
							<ul class="egov-noBack">
								...
								<li>color : 색상</li>
								<li>사용법은 아래와 같다.</li>
								<li><img style="max-width:100%;" src="<c:url value="/images/egovframework/mbl/rte/guide/img_html8.gif" />"/></li>
							</ul>
						</div>
						...
						<div class="egov-deth2">
							<ul class="egov-noBack">
								<li><img style="max-width:100%;" src="<c:url value="/images/egovframework/mbl/rte/guide/img_html9.gif" />"/></li>
								<li>사용법은 아래와 같다.</li>
