				...
				<div class="content-primary">
					...
					<div class="egov-deth1">
						...
						<dl class="egov-deth3">
							...
							<colgroup><col width="30%"><col width="15%"><col width="55%"></colgroup>
							<thead>
							<tr>
								<th>시스템명</th>
								<th>코드</th>
					...
					<div class="egov-deth1">
						...
						<dl class="egov-deth3">
							...
							<dd><table class="egov-table-code">
							<colgroup><col width="20%"><col width="25%"><col width="15%"><col width="40%"></colgroup>
							<thead>
							<tr>
								<th>시스템명 / 코드</th>
								<th>서브 시스템명</th>
					...
					<div class="egov-deth1">
						...
						<div class="egov-deth2">
							...
							<ul class="link">
					 			...
					 			<li class="egov-txtIn7"><img src="<c:url value="/images/egovframework/mbl/rte/guide/img_arrow1.png" />"/><b>일련번호</b>  - 구분자 3자리</li>
					 			<li class="egov-txtIn5"><img src="<c:url value="/images/egovframework/mbl/rte/guide/img_arrow2.png" />"/><b>시스템일반</b> - 서브시스템 코드 3자리</li>
					 			<li class="egov-txtIn2"><img src="<c:url value="/images/egovframework/mbl/rte/guide/img_arrow3.png" />"/><b>커뮤니케이션시스템</b> - 시스템 코드 3자리</li>
					 		</ul>
						</div>
					</div>
