						...
						<div class="egov-deth2">
                             <div data-role="fieldcontain">
								 <fieldset data-role="controlgroup" data-type="horizontal" >
									 <legend>동의 여부: </legend>
									 <input type="radio" name="radio-2" id="radio-1" value="choice-1" checked="checked" />
									 <label for="radio-1">Yes</label>
									 <input type="radio" name="radio-2" id="radio-2" value="choice-2" />
									 <label for="radio-2">No</label>
								 </fieldset>
							</div>
							<ul class="link">
								 ...
								 <li class="egov-txtIn2">&lt;legend&gt;동의 여부: &lt;/legend&gt;</li>
								 <li class="egov-txtIn2">&lt;input type="radio" name="radio-2" id="radio-1" value="choice-1" checked="checked" /&gt;</li>
								 <li class="egov-txtIn2">&lt;label for="radio-1"&gtYes&lt;/label&gt;</li>
								 <li class="egov-txtIn2">&lt;input type="radio" name="radio-2" id="radio-2" value="choice-2" /&gt;</li>
								 <li class="egov-txtIn2">&lt;label for="radio-2"&gt;No&lt;/label&gt;</li>
								 <li class="egov-txtIn1">&lt;/fieldset&gt;</li>
								 <li>&lt;/div&gt;</li>
					 		</ul>
