					...
					<div class="egov-deth1">
						...
						<div class="egov-deth2">
							<ul data-role="listview" data-inset="true">
								<li><a href="#"> 
									<img src="<c:url value="/images/egovframework/mbl/rte/guide/components/list/coffee.jpg" />">
									<h3>Americano</h3> 
									<p><strong>Beverage Guide</strong></p> 
									<p>에스프레소에 뜨거운 물을 혼합한 커피</p> 
								</a></li> 
								<li><a href="#">
									<img src="<c:url value="/images/egovframework/mbl/rte/guide/components/list/waffle.jpg" />">
									<h3>Waffle</h3> 
									<p><strong>Waffle Guide</strong></p> 
									<p>고소하고 달콤한 와플</p> 
								</a></li>
								<li><a href="#">
									<img src="<c:url value="/images/egovframework/mbl/rte/guide/components/list/ice.jpg" />">
									<h3>Icecream</h3> 
