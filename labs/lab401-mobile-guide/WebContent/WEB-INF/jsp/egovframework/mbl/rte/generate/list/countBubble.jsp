...
<html>
    <head>
        ...
        function changeTab() {
            ...
            f.action="<c:url value="/generate/list/countBubble.do"/>";
            f.target="_self";
        ...
        function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/list/countBubbleGen.do"/>";
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Table / List View <span class="sub">- Count Bubble</span></h1>
					</div>
                    ...
                    <div class="gen-Group">
                        <div class="gen-grid">
                            <ul class="c-attr">
                                <li>
                                	...
                                	<div class="gen-wid2">
	                                    <select name="compType" data-role="none" class="gen-sele" onChange="javascript:changeType(this.value);">
	                                        ...
	                                        <option value="countBubble" selected="selected">Count Bubble</option>
                                ...
                                <li>
                                	<div class="gen-wid1"><strong>Count Color</strong></div>
                                	<div class="gen-wid2">
		                                <select name="attrIconTheme" data-role="none" class="gen-sele">
		                                    <option value="">선택</option>
		                                    <option value="attr:data-count-theme=a" ${(xml.component["attrIconTheme"] == 'attr:data-count-theme=a') ? 'selected="selected"' : ''}>검정</option>
		                                    <option value="attr:data-count-theme=b" ${(xml.component["attrIconTheme"] == 'attr:data-count-theme=b') ? 'selected="selected"' : ''}>파랑</option>
		                                    <option value="attr:data-count-theme=c" ${(xml.component["attrIconTheme"] == 'attr:data-count-theme=c') ? 'selected="selected"' : ''}>회색</option>
		                                    <option value="attr:data-count-theme=d" ${(xml.component["attrIconTheme"] == 'attr:data-count-theme=d') ? 'selected="selected"' : ''}>흰색</option>
		                                    <option value="attr:data-count-theme=e" ${(xml.component["attrIconTheme"] == 'attr:data-count-theme=e') ? 'selected="selected"' : ''}>노랑</option>
		                                    <option value="attr:data-count-theme=f" ${(xml.component["attrIconTheme"] == 'attr:data-count-theme=f') ? 'selected="selected"' : ''}>빨강</option>
		                                    <option value="attr:data-count-theme=g" ${(xml.component["attrIconTheme"] == 'attr:data-count-theme=g') ? 'selected="selected"' : ''}>초록</option>        
		                                </select>
	                                </div>                             
                                </li>
                            </ul>                        
                                    ...
                                    <ul class="c-attr">
                                        <li>
                                			...
                                			<div class="gen-wid2">
	                                            ...
	                                            <input type="text" name="compText_${compIndex}" value="<c:out value='${xml.component[compTextName]}' default="Count ${compIndex}" />" data-role="none" class="gen-sele" />                                            
                                        	</div>
                                        </li>
                                        <li>
                                        	<div class="gen-wid1"><strong>카운트</strong></div>
                                			<div class="gen-wid2">
	                                            <c:set var="compInputCountName">compInputCount_${compIndex}</c:set>
	                                            <input type="text" name="compInputCount_${compIndex}" value="<c:out value='${xml.component[compInputCountName]}' default="${compIndex}" />" data-role="none" class="gen-sele" />
                                            </div>                                         
                                        </li>
                                    </ul>                                   
                                </div>      
