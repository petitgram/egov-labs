            ...
            <div data-role="content" data-theme="d">
                ...
                <div class="content-primary">
                    ...
                    <div class="egov-deth1">
                        <h2>Dialog 형식</h2>
                        <p>링크에 <strong>data-rel="dialog"</strong> 및 <strong>data-transition="slide, slidedown, slideup, fade, flip"</strong> 속성을 추가하여 다이얼 로그의 효과적인 표출 효과를 사용 할 수 있다.<br>
                    ...
                    <div class="egov-deth1">
                        ...
                        * 각각의 메뉴는 상세 화면으로의 이동을 의미하는 시작적인 단서를 제공하거나 터치를 유도할 수 있도록 버튼 스타일로 제공하는 것이 바람직하다.</p>
                        <div class="egov-deth2">                            
