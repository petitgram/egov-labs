...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	<ul data-role="listview" data-inset="true" data-dividertheme="b">
	    <li data-role="list-divider" class="egov-bar-main1"><a href="<c:url value="/guide/intro/intro.do" />"style="color:#fff;" data-ajax="false">Overview</a></li>
        ...
        <li><a href="<c:url value="/guide/template/designRule.do" />" data-ajax="false">디자인 원칙 및 제약사항</a></li>
