		...
		<div data-role="page" class="type-index">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
	        		...
	        		<div class="egov-deth1">
						<h2>모양변경</h2>
						<p>Selctor의 모양을 사각으로 만들고 싶다면 &lt;select&gt; Tag에 <strong>data-corners="false"</strong>을 추가한다</p>
						<div class="egov-deth2">
							<div data-role="fieldcontain">
								<label for="select-choice-1" class="select">선택 하시오:</label>
					 		...
					 		<ul class="link">
								<li>&lt;div data-role="fieldcontain"&gt;</li>
								<li class="typ1">&lt;label for="select-choice-1" class="select"&gt;선택 하시오:&lt;/label&gt;</li>
								<li class="typ1">&lt;select name="select-choice-1" id="select-choice-1" data-corners="false"&gt;</li>
								<li class="typ2">&lt;option value="apple"&gt;사과&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="banana"&gt;바나나&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="grapes"&gt;포도&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="onion"&gt;양파&lt;/option&gt;</li>
						...
						<p>Selctor의 아이콘을 변경하고 싶다면  &lt;select&gt; Tag에 <strong>data-icon="[icon]"</strong>을 추가한다</p>
						<div class="egov-deth2">
							<div data-role="fieldcontain">
								<label for="select-choice-1" class="select">선택 하시오:</label>
					 		...
					 		<ul class="link">
								<li>&lt;div data-role="fieldcontain"&gt;</li>
								<li class="typ1">&lt;label for="select-choice-1" class="select"&gt;선택 하시오:&lt;/label&gt;</li>
								<li class="typ1">&lt;select name="select-choice-1" id="select-choice-1" data-icon="star"&gt;</li>
								<li class="typ2">&lt;option value="apple"&gt;사과&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="banana"&gt;바나나&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="grapes"&gt;포도&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="onion"&gt;양파&lt;/option&gt;</li>
						...
						<p>Selctor의 아이콘의 위치를 변경하고 싶다면  &lt;select&gt; Tag에 <strong>data-iconpos="[right, left]"</strong>을 추가한다</p>
						<div class="egov-deth2">
							<div data-role="fieldcontain">
								<label for="select-choice-1" class="select">선택 하시오:</label>
					 		...
					 		<ul class="link">
								<li>&lt;div data-role="fieldcontain"&gt;</li>
								<li class="typ1">&lt;label for="select-choice-1" class="select"&gt;선택 하시오:&lt;/label&gt;</li>
								<li class="typ1">&lt;select name="select-choice-1" id="select-choice-1" data-iconpos="left"&gt;</li>
								<li class="typ2">&lt;option value="apple"&gt;사과&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="banana"&gt;바나나&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="grapes"&gt;포도&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="onion"&gt;양파&lt;/option&gt;</li>
						...
						<p>Selctor의 크기를 작게 하고 싶다면  &lt;select&gt; Tag에 <strong>data-inline="true"</strong>을 추가한다</p>
						<div class="egov-deth2">
							<div data-role="fieldcontain">
								<label for="select-choice-1" class="select">선택 하시오:</label>
					 		...
					 		<ul class="link">
								<li>&lt;div data-role="fieldcontain"&gt;</li>
								<li class="typ1">&lt;label for="select-choice-1" class="select"&gt;선택 하시오:&lt;/label&gt;</li>
								<li class="typ1">&lt;select name="select-choice-1" id="select-choice-1" data-inline="true"&gt;</li>
								<li class="typ2">&lt;option value="apple"&gt;사과&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="banana"&gt;바나나&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="grapes"&gt;포도&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="onion"&gt;양파&lt;/option&gt;</li>
						...
						<p>Selctor의 Shadow를 제거하고싶다면  &lt;select&gt; Tag에 <strong>data-shadow="false"</strong>을 추가한다</p>
						<div class="egov-deth2">
							<div data-role="fieldcontain">
								<label for="select-choice-1" class="select">선택 하시오:</label>
					 		...
					 		<ul class="link">
								<li>&lt;div data-role="fieldcontain"&gt;</li>
								<li class="typ1">&lt;label for="select-choice-1" class="select"&gt;선택 하시오:&lt;/label&gt;</li>
								<li class="typ1">&lt;select name="select-choice-1" id="select-choice-1" data-shadow="false"&gt;</li>
								<li class="typ2">&lt;option value="apple"&gt;사과&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="banana"&gt;바나나&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="grapes"&gt;포도&lt;/option&gt;</li>
								<li class="typ2">&lt;option value="onion"&gt;양파&lt;/option&gt;</li>
	               	...
	               	<div class="egov-deth1">
						...
						<div class="egov-deth2">
							...
							<ul class="link">
								...
								<li class="egov-txtIn3">&lt;option value=&quot;tomato&quot;&gt토마토&lt;/option&gt;</li>
								<li class="egov-txtIn3">&lt;option value=&quot;carrot&quot; disabled=&quot;disabled&quot;&gt당근 (disabled)&lt;/option&gt;</li>
						...
						<p>option을 비활성화하고 싶다면 &lt;option value&gt;에 <strong>disabled="disabled"</strong>를 추가한다</p>
						<div class="egov-deth2">
					     	<div data-role="fieldcontain">
							<label for="select-choice-custom" class="select">선택하시오 : </label>
							<select name="select-choice-1" id="select-choice-custom" data-native-menu="false">
					...
					<div class="egov-tit">
						...
						<div class="egov-deth2">
				                ...
				                <ul class="link">
									<li>&lt;div data-role="fieldcontain" data-theme="a"&gt;</li>
