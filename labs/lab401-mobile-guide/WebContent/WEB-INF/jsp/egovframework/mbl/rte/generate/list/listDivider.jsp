...
<html> 
    <head>
        ...
        function changeTab() {
            ...
            f.action="<c:url value="/generate/list/listDivider.do"/>";
            f.target="_self";
        ...
        function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/list/listDividerGen.do"/>";
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Table / List View <span class="sub">- List Divider</span></h1>
					</div>
                               ...
                               <li>
                                    ...
                                    <div class="gen-wid2">
	                                    <select name="compType" data-role="none" class="gen-sele" onChange="javascript:changeType(this.value);">
	                                        ...
	                                        <option value="listDivider" selected="selected">List Divider</option>
	                            ...
	                            <li>
	                                <div class="gen-wid1"><strong>Divider Text</strong></div>
	                                <div class="gen-wid2">
	                                    <input type="text" name="etcDividerText" value="<c:out value='${xml.component["etcDividerText"]}' default="divider" />" data-role="none" class="gen-sele" />                              
	                                </div>
	                            </li>                                                        
	                            <li>
	                                <div class="gen-wid1"><strong>Divider 색상</strong></div>
	                                <div class="gen-wid2">
		                                <select name="attrDividertheme" data-role="none" class="gen-sele">
		                                    <option value="">선택</option>
		                                    <option value="attr:data-divider-theme=a" ${(xml.component["attrDividertheme"] == 'attr:data-divider-theme=a') ? 'selected="selected"' : ''}>검정</option>
		                                    <option value="attr:data-divider-theme=b" ${(xml.component["attrDividertheme"] == 'attr:data-divider-theme=b') ? 'selected="selected"' : ''}>파랑</option>
		                                    <option value="attr:data-divider-theme=c" ${(xml.component["attrDividertheme"] == 'attr:data-divider-theme=c') ? 'selected="selected"' : ''}>회색</option>
		                                    <option value="attr:data-divider-theme=d" ${(xml.component["attrDividertheme"] == 'attr:data-divider-theme=d') ? 'selected="selected"' : ''}>흰색</option>
		                                    <option value="attr:data-divider-theme=e" ${(xml.component["attrDividertheme"] == 'attr:data-divider-theme=e') ? 'selected="selected"' : ''}>노랑</option>
		                                    <option value="attr:data-divider-theme=f" ${(xml.component["attrDividertheme"] == 'attr:data-divider-theme=f') ? 'selected="selected"' : ''}>빨강</option>
		                                    <option value="attr:data-divider-theme=g" ${(xml.component["attrDividertheme"] == 'attr:data-divider-theme=g') ? 'selected="selected"' : ''}>초록</option>        
		                                </select>                         
	                                </div>
	                            </li>    
                            </ul>                        
                                    ...
                                    <ul class="c-attr">
                                        <li>
                                            ...
                                            <div class="gen-wid2">  
	                                            ...
	                                            <input type="text" name="compText_${compIndex}" value="<c:out value='${xml.component[compTextName]}' default="Divider ${compIndex}" />" data-role="none" class="gen-sele" />
                                            </div>
                                        </li>
                                    </ul>
                                </div>      
