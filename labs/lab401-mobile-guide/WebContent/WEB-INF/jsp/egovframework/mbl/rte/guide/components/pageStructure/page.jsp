            ...
            <div data-role="content" data-theme="d">
                ...
                <div class="content-primary">
					...
					<div class="egov-Dsclaimer">
						<h2>유의사항</h2>
						<p>각 브라우저 마다 history를 관리 하는 방식(pushstate)이 상이 하기 때문에 이를 공통적으로 지원해주기 위하여 history.js를 import하여 사용할 것을 권고한다.</p>
						...
						<div id = "example">
							<div class="egov-Example">
								<ul class="link">
									<li><strong>jquery.mobile-1.0b3.min.js 위에 선언</strong></li>
									<li>&lt;!-- History.js --&gt;<li>
							...
							<div class="egov-Example">
								<ul class="link">
									<li>pushstate 지원 브라우져 : Chrome(5.0), Firefox(4.0), Opera(11.50), safari(5.0)</li>
                    ...
                    <div class="egov-deth1">
                        ...
                        <div class="egov-deth2">
                            <ul class="link">
                                ...
                                <li class="egov-txtIn2"><strong>&lt;link rel="stylesheet" href="/css/egovframework/mbl/cmm/jquery.mobile-1.0b3.min.css"/&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;link rel="stylesheet" href="/css/egovframework/mbl/cmm/EgovMobile.css" /&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;script src="/js/egovframework/mbl/cmm/jquery-1.6.2.min.js"&gt;&lt;/script&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;script src="/js/egovframework/mbl/cmm/jquery.mobile-1.0b3.min.js"&gt;&lt;/script&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;script src="/js/egovframework/mbl/cmm/EgovMobile.js"&gt;&lt;/script&gt;</strong></li>
                                <li class="egov-txtIn1">&lt;/head&gt;</li>
                    ...
                    <div class="egov-deth1">
                        ...
                        <div class="egov-deth2">
                            <ul class="link">
                                ...
                                <li class="egov-txtIn2">&lt/div&gt;</li>
                                ...
                                <li><br></li>
                                <li class="egov-txtIn1">&lt/div&gt;</li>
