				...
				<div class="content-primary">
					...
					<div class="egov-deth1">
						...
						<p>Collapsible Block을 이용하기 위해서는 블럭을 만들려는 컨텐츠를 감싸고 있는 div Tag에
							...
							타이틀로 사용되며 접힘/펼침을 시각적으로 표현하기 위한 +,- 아이콘이 타이틀 앞에 자동으로 추가 된다.또한 처음 화면을 로드 할 때
					...
					<div class="egov-deth1">
						<h2>색상변경</h2>
						<p>색상변경 시에는 data-role="collapsible"이 선언된 div Tag에<strong>data-theme=[a~g]</strong>을 선언하여
							 색상을 변경한다.(총 7가지 색상 지원)
						</p>
						<div class="egov-deth2">
							...
							<div data-role="collapsible" data-collapsed="false" data-theme="g"> 
								...
								<p>data-theme="g" Theme collapsible header content</p> 
							</div>
					 		<ul class="link">
								<li>&lt;div data-role="collapsible" data-theme="b"&gt;</li>
								<li class="egov-txtIn1">&lt;h3&gt;data-theme="b" collapsible header&lt;/h3&gt;</li>
								<li class="egov-txtIn1">&lt;p&gt;data-theme="b" collapsible header content&lt;/p&gt;</li>
								<li>&lt;/div&gt;</li>
								<li>&lt;div data-role="collapsible" data-collapsed="false" data-theme="g"&gt;</li>
								<li class="egov-txtIn1">&lt;h3&gt;data-theme="g" collapsible header&lt;/h3&gt;</li>
								<li class="egov-txtIn1">&lt;p&gt;data-theme="g" Theme collapsible header content&lt;/p&gt;</li>
								<li>&lt;/div&gt;</li>
					 		</ul>						
						</div>
					</div>
