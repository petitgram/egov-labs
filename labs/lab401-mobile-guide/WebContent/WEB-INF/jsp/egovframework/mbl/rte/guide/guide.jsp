	...
	<div data-role="content" data-theme="d">
		...
		<div class="content-primary">
			<ul data-role="listview" data-inset="true" >
				<li data-role="list-divider" class="egov-bar-main2">UX Componet</li>
				...
				<li><a href="<c:url value="/guide/components/progress/progress.do" />" data-ajax="false">Progress Dialog / Bar</a></li>
				...
				<li><a href="<c:url value="/guide/components/picker/picker.do" />" data-ajax="false">Date / Time Picker</a></li>
		        ...
		        <li data-role="list-divider" class="egov-bar-main4">가이드 프로그램</li>
		        <li data-icon="gear"><a href="<c:url value="/generate/button/button.do" />" data-ajax="false" data-icon="gear">UX Code Generator</a></li>     
			</ul>
		</div><!--/content-primary-->	
