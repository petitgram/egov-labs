...
<html> 
    <head>
        ...
        function changeTab() {
            ...
            f.action = "<c:url value="/generate/menu/list.do"/>";
            f.target="_self";
            f.submit();
        }
        ...
        function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/menu/listGen.do"/>";
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Menu <span class="sub">- List</span></h1>
					</div>
                        ...
                        <div id="tabs">                     
                            ...
                            <div id="tabs-${compIndex}" class="gen-cont">
                                <div class="gen-grid">
                                    <ul class="c-attr">
                                        <li>
                                        	<div class="gen-wid1"><strong>상위메뉴 대제목 ${compIndex}</strong></div>
                                        	<div class="gen-wid2">
                                        ...
                                        <li>
                                        	<div class="gen-wid1"><strong>상위메뉴 소제목 ${compIndex}</strong></div>
                                        	<div class="gen-wid2">
                                        ...
                                        <li>
                                        	<div class="gen-wid1"><strong>하위메뉴 ${compIndex}-1</strong></div>
                                        	<div class="gen-wid2">
                                        		<c:set var="compInputText">compInputText_${compIndex}_1</c:set>
                                            	<input type="text" name="compInputText_${compIndex}_1" value="<c:out value="${xml.component[compInputText]}" default="Nested Menu ${compIndex}_1" />" data-role="none" class="gen-sele" />
                                        	</div>
                                        </li>
                                        <li>
                                        	<div class="gen-wid1"><strong>하위메뉴 ${compIndex}-2</strong></div>
                                        	<div class="gen-wid2">
                                        		<c:set var="compInputText">compInputText_${compIndex}_2</c:set>
                                            	<input type="text" name="compInputText_${compIndex}_2" value="<c:out value="${xml.component[compInputText]}" default="Nested Menu ${compIndex}_2" />" data-role="none" class="gen-sele" />
                                        	</div>
                                        </li>
                                        <li>
                                        	<div class="gen-wid1"><strong>하위메뉴 ${compIndex}-3</strong></div>
                                        	<div class="gen-wid2">
                                        		<c:set var="compInputText">compInputText_${compIndex}_3</c:set>
                                            	<input type="text" name="compInputText_${compIndex}_3" value="<c:out value="${xml.component[compInputText]}" default="Nested Menu ${compIndex}_3" />" data-role="none" class="gen-sele" />
                                        	</div>
                                        </li>
                                    </ul>                           
                                </div>      
