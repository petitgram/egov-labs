                    ...
                    <div class="egov-deth1">
                        ...
                        <div class="egov-deth2">
                            ...
                            <ul class="link">
                                 ...
                                 <li>&lt;a href="/guide/components/dialog/back.do" data-role="button" data-rel="dialog" data-transition="flip"&gt;flip &lt;/a&gt;</li>                            </ul>
                        </div>
                    </div>
                   
                    <div class="egov-deth1">
                        <h2>기타 Dialog</h2>
                        <p>기타 Dialog는 자바 스크립트를 이용하여 Alert, Confirm 등의 창을 띄운다. 아래 스크립트 코드를  EgovMobile.js와 jquery.mobile-1.0b3.min.js 사이에 선언하여 이벤트를 걸어 사용한다.
