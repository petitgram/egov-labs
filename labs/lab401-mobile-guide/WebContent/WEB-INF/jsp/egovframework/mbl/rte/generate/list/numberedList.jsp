...
<html> 
    <head>
        ...
        function changeTab() {
            ...
            f.action="<c:url value="/generate/list/numberedList.do"/>";
            f.target="_self";
        ...
        function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/list/numberedListGen.do"/>";
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Table / List View <span class="sub">- Numbered List</span></h1>
					</div>
                               ...
                               <li>
                                    ...
                                    <div class="gen-wid2">
	                                    <select name="compType" data-role="none" class="gen-sele" onChange="javascript:changeType(this.value);">
	                                        ...
	                                        <option value="numberedList" selected="selected">Numbered List</option>
	                            ...
	                            <li>
	                                ...
	                                <div class="gen-wid2">
	                                    <input type="radio" name="linkType" id="linkType" data-role="none" value="" ${(xml.component["linkType"] == null || xml.component["linkType"] == '') ? 'checked="checked"' : ''} /><label for="">Read Only</label>
	                                    <input type="radio" name="linkType" id="linkType" data-role="none" value="list" ${(xml.component["linkType"] == 'list') ? 'checked="checked"' : ''} /><label for="">Link List</label>                 
	                                </div>
	                            </li>                            
	                        </ul>    
                        </div>                      
                                    ...
                                    <ul class="c-attr">
                                        <li>
                                            ...
                                            <div class="gen-wid2">  
	                                            ...
	                                            <input type="text" name="compText_${compIndex}" value="<c:out value='${xml.component[compTextName]}' default="Numbered ${compIndex}" />" data-role="none" class="gen-sele" />
                                        </li>
                                    </ul>
                                </div>      
                            </div>      
