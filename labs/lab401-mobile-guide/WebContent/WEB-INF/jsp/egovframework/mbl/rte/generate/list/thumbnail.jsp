...
<html> 
    <head>
        ...
        function changeTab() {
            ...
            f.action="<c:url value="/generate/list/thumbnail.do"/>";
            f.target="_self";
        ...
        function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/list/thumbnailGen.do"/>";
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Table / List View <span class="sub">- Thumbnail</span></h1>
					</div>		
                    ...
                    <div class="demo">
                        <div id="tabs">                     
                            ...
                            <c:set var="icon_coffee">${pageContext.request.contextPath}/images/egovframework/mbl/rte/guide/components/list/coffee.jpg</c:set>
                            <c:set var="icon_waffle">${pageContext.request.contextPath}/images/egovframework/mbl/rte/guide/components/list/waffle.jpg</c:set>
                            <c:set var="icon_ice">${pageContext.request.contextPath}/images/egovframework/mbl/rte/guide/components/list/ice.jpg</c:set>                            
                            <c:forEach var="compIndex" begin="1" end="${compCount}">
                                    ...
                                    <ul class="c-attr">
                                        <li>
                                            ...
                                            <div class="gen-wid2"> 
	                                            ...
	                                            <input type="text" name="compText_${compIndex}" value="<c:out value='${xml.component[compTextName]}' default="Thumbnail ${compIndex}" />" data-role="none" class="gen-sele" />
	                                        </div>                                            
                                        </li>
                                        <li>
                                            <div class="gen-wid1"><strong>썸네일 이미지</strong></div>
                                            <div class="gen-wid2"> 
	                                            <c:set var="ccompImageName">compImage_${compIndex}</c:set>
	                                            <select name="compImage_<c:out value="${compIndex}" />" data-role="none" class="gen-sele">
	                                                <option value="${icon_coffee}" ${(xml.component[ccompImageName] == icon_coffee) ? 'selected="selected"' : ''}>커피</option>
	                                                <option value="${icon_waffle}" ${(xml.component[ccompImageName] == icon_waffle) ? 'selected="selected"' : ''}>와플</option>
	                                                <option value="${icon_ice}" ${(xml.component[ccompImageName] == icon_ice) ? 'selected="selected"' : ''}>아이스 크림</option>
	                                            </select>      
                                            </div>                                        
                                        </li>
                                    </ul>                                    
