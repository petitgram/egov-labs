					...
					<div class="egov-deth1">
						...
						<div class="egov-deth2">
							<ul class="link">
					 			...
					 			<li class="egov-txtIn10"><img src="<c:url value="/images/egovframework/mbl/rte/guide/code_fileName.png" />"/></li>
					 			<li class="egov-txtIn5"><img src="<c:url value="/images/egovframework/mbl/rte/guide/code_fileName2.png" />"/>- [시스템 코드]_[서브시스템 코드]_[구분자]
					 			</li>
					 		</ul>
						</div>
					</div>
