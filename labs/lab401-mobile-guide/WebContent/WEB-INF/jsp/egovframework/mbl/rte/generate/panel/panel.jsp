									...
									<div class="gen-wid1"><strong>체크무늬</strong></div>
			                     	<div class="gen-wid2">
			                     		<select name="cssPattern" data-role="none" class="gen-sele">
						                    ...
						                    <option value="css:egov-panel-pattern-b" ${(xml.component["cssPattern"] == 'css:egov-panel-pattern-b') ? 'selected="selected"' : ''}>파랑</option>
						                    <option value="css:egov-panel-pattern-c" ${(xml.component["cssPattern"] == 'css:egov-panel-pattern-c') ? 'selected="selected"' : ''}>회색</option>
