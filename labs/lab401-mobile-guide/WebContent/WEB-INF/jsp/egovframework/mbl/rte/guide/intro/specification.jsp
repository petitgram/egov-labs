...
<html> 
    <head>
		...
		<!-- History.js -->
		<script src="<c:url value="/js/egovframework/mbl/cmm/jquery.history.js"/>"></script> 
		...
		<div data-role="page" class="type-index">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
                    ...
                    <colgroup><col width="20%"><col width="12%"><col width="68%"></colgroup>
                    <thead>
                    <tr>
                        <th>컴포넌트</th>
                    ...
                    <!-- Button -->
                    <tr>
                        <td rowspan="6" class="type1"><strong>Button</strong></td>
                    ...
                    <!-- Tabs --> 
       				<tr>
                        <td rowspan="4" class="type1"><strong>Tabs</strong></td>
                        <td class="type1">설명</td>
                    ...
                    <tr>
                        ...
                        <td>slide, slideup, slidedown, pop, fade, flip</td>
                    </tr>
                    <tr>
                        <td class="type1">형태</td>
                    ...
                    <tr>
                        <td rowspan="3" class="type1"><strong>Processing Dialog / Bar</strong></td>
                        <td class="type1">설명</td>
                        <td>페이지 전환간 진행 상태를 확인 할 수 있는 Progress Dialog/Bar 제공</td>
                    </tr>
                    <tr>
                        <td class="type1">형태</td>
                        <td>Processing Dialog, Processing Bar</td>
                    </tr>
                    <tr>
                        <td class="type1">색상</td>
                        <td>검정, 파랑, 회색, 흰색, 노랑, 빨강, 초록  </td>
                    ...
                    <tr>
                        ...
                        <td>Nested List, Numbered List, Split Button, List Divider, Count Bubble, 
                        	Thumbnail, List icon, Content Formatting, Search Filter Bar </td>
                    </tr>
                    <tr>
                        <td class="type1">색상</td>
                        <td>검정, 파랑, 회색, 흰색, 노랑, 빨강, 초록  </td>
                    ...
                    <tr>
                        <td class="type1">형태</td>
                        <td>Android Date Picker, Popup Calendar, Android Time Picker </td>
                    </tr>
                    ...
                    <tr>
                        <td class="type1">형태</td>
                        <td>arrow-l, arrow-r, arrow-u, arrow-d, delete, plus, minus, check, gear, refresh, forward, back, grid, star, alert, info, search, home, phone, mail</td>
                    </tr>
                     <tr>
                        <td class="type1">색상</td>
                        <td>검정, 파랑, 회색, 흰색, 노랑, 빨강, 초록  </td>
                    ...
                    <!-- Collapsible Block -->  
                    <tr>
                        <td rowspan="4" class="type1"><strong>Collapsible Block</strong></td>
                        <td class="type1">설명</td>
