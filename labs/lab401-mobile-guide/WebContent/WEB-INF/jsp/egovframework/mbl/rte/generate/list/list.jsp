...
<html> 
    <head>
        ...
        function changeTab() {
            ...
            f.action="<c:url value="/generate/list/list.do"/>";
            f.target="_self";
        ...
        function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/list/listGen.do"/>";
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Table / List View <span class="sub">- List</span></h1>
					</div>
                                    ...
                                    <ul class="c-attr">
                                        <li>
                                			...
                                			<div class="gen-wid2">
	                                            ...
	                                            <input type="text" name="compText_${compIndex}" value="<c:out value='${xml.component[compTextName]}' default="list ${compIndex}" />" data-role="none" class="gen-sele" />
                                        	</div>
                                        </li>
                                    </ul>
                                </div>
