                        ...
                        <div class="gen-grid">
                            <ul class="c-attr">
                                <li>
                                    ...
                                    <div class="gen-wid2">
										<select name="etcOptionsTimeFormat" data-role="none" class="gen-sele" >
										   <option value="" ${(xml.component["etcOptionsTimeFormat"] == null || xml.component["etcOptionsTimeFormat"] == '') ? 'checked="checked"' : ''} >24시간</option>
										    <option value="timeFormat:12"  ${(xml.component["etcOptionsTimeFormat"] == 'timeFormat:12') ? 'checked="checked"' : ''} >12시간</option>
										</select>
                                    </div>                              
                                </li>
                                <li>
