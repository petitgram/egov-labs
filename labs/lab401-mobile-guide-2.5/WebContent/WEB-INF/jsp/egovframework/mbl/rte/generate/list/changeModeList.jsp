...
<html lang="kr"> 
    <head>
        ...
        function changeTab() {
            ...
            f.action="<c:url value="/generate/list/changeModeList.do"/>";
            f.target="_self";
        ...
        function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/list/changeModeListGen.do"/>";
        ...
        function showSub(val, seq) {        	

        	if(val != 'data-swipefg=*menu*'){
            	$("#url1_"+seq).hide();
            	$("#url2_"+seq).hide();
	        }
            else{
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Table / List View <span class="sub">- Change Mode List</span></h1>
					</div>
                                ...
                                <li>
                                	...
                                	<div class="gen-wid2">
	                                    <select name="compType" data-role="none" class="gen-sele" onChange="javascript:changeType(this.value);">
	                                        ...
	                                        <option value="changeModeList" selected="selected">Change Mode List</option>
                                    ...
                                    <ul class="c-attr">
                                    	<li>
                                			...
                                			<div class="gen-wid2">
	                                            ...
	                                            <input type="text" name="compText_${compIndex}" value="Swipe list ${compIndex}" data-role="none" class="gen-sele" />
                                        	</div>
                                        </li>
                                        <li>
                                        	<div class="gen-wid1"><strong>구분</strong></div>
                                			<div class="gen-wid2">
	                                            <c:set var="swipefg">${(param.changeStatus == 'change') ? param.swipefg : xml.component["swipefg"]}</c:set>
	                                            <select name="swipefg_${compIndex}" data-role="none" class="gen-sele" onChange="javascript:showSub(this.value, ${compIndex});">
		                                            <option value="data-swipefg=*menu*" selected >Swipe Menu</option>
		                                        	<option value="data-swipefg=*delete*" >Swipe Delete</option>
	                                            </select>
                                        	</div>
                                        </li>
                                        <li id="url1_${compIndex}">
                                        	<div class="gen-wid1"><strong>Menu URL1</strong></div>
                                			<div class="gen-wid2">
	                                            <c:set var="swipeurl1">swipeurl1_${compIndex}</c:set>
	                                            <input type="text" name="swipeurl1_${compIndex}" value="/guide/guide.do" data-role="none" class="gen-sele" />                                        
                                        	</div>
                                        </li>
                                        <li id="url2_${compIndex}">
                                        	<div class="gen-wid1"><strong>Menu URL2</strong></div>
                                			<div class="gen-wid2">
	                                            <c:set var="swipeurl2">swipeurl2_${compIndex}</c:set>
	                                            <input type="text" name="swipeurl2_${compIndex}" value="/guide/guide.do" data-role="none" class="gen-sele" />
                                        	</div>
                                        </li>                                        
                                    </ul>
                                </div>      
