    ...
    <head>
        ...
        <script>
		 ...
		 function changeTab() {
			 ...
			 f.action="<c:url value="/generate/check/check.do"/>";
			 f.target="_self";
		 ...
		 function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/check/checkGen.do"/>";
					...
					<div class="gen-Group">
                        ...
                        <div class="gen-grid">
                            <ul class="c-attr" id="groupInfo">
                                <li>
	                                <div class="gen-wid1"><strong>체크박스 수</strong></div>
			                     	<div class="gen-wid2">
					...
					<div class="demo">
						<div id="tabs">						
							<ul class="tabTitle" id="tabTitle">
								...
								<li><a href="#tabs-${compIndex}">Check ${compIndex}</a></li>
								</c:forEach>
							</ul>
							<c:forEach var="compIndex" begin="1" end="${compCount}">
							<div id="tabs-${compIndex}" class="gen-cont">
		                        <div class="gen-grid">
                                    <ul class="c-attr">
                                        <li>
                                        	<div class="gen-wid1"><strong>체크박스 명</strong></div>
					                     	<div class="gen-wid2">
					                     		<c:set var="compTextName">compText_${compIndex}</c:set>
                                            	<input type="text" name="compText_${compIndex}" value="<c:out value='${xml.component[compTextName]}' default="Check ${compIndex}" />" data-role="none" class="gen-sele" />           
					                     	</div> 
                                        </li>
                                    </ul>	
		                        </div>      
