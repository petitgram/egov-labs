                            ...
                            <ul class="c-attr" id="groupInfo">
                                <li>
                       			...
                       			<li>
			                     	...
			                     	<div class="gen-wid2">
			                     		<input type="radio" name="compGroup" ${(compCount == 1) ? 'disabled="disabled"' : ''} data-role="none" value="" ${(xml.component["compGroup"] == null || xml.component["compGroup"] == '') ? 'checked="checked"' : ''}>No
			                            <input type="radio" name="compGroup" ${(compCount == 1) ? 'disabled="disabled"' : ''} data-role="none" value="compGroup" ${(xml.component["attrGroup"] == 'compGroup') ? 'checked="checked"' : ''} >Yes                              
			                     	</div>
			                    </li>                                
                            </ul>
                        </div>    						
							...
							<div id="tabs-${compIndex}" class="gen-cont">
		                        <div class="gen-grid">
                                    <ul class="c-attr">
	                                    ...
	                                    <li>
	                                      	<div class="gen-wid1"><strong>헤더색상</strong></div>
	                                      	<div class="gen-wid2">
	                                    ...
	                                    <li>
	                                      	<div class="gen-wid1"><strong>내용색상</strong></div>
	                                      	<div class="gen-wid2">
	                                      	   <c:set var="compContentColorName">compContentColor_${compIndex}</c:set>
	                                           <select name="compContentColor_${compIndex}" data-role="none" class="gen-sele">
		                                        <option value="">선택</option>
		                                        <option value="attr:data-content-theme=a" ${(xml.component[compContentColorName] == 'attr:data-content-theme=a') ? 'selected="selected"' : ''}>검정</option>
		                                        <option value="attr:data-content-theme=b" ${(xml.component[compContentColorName] == 'attr:data-content-theme=b') ? 'selected="selected"' : ''}>진한 회색</option>
		                                        <option value="attr:data-content-theme=c" ${(xml.component[compContentColorName] == 'attr:data-content-theme=c') ? 'selected="selected"' : ''}>회색</option>
		                                        <option value="attr:data-content-theme=d" ${(xml.component[compContentColorName] == 'attr:data-content-theme=d') ? 'selected="selected"' : ''}>흰색</option>
		                                        <option value="attr:data-content-theme=e" ${(xml.component[compContentColorName] == 'attr:data-content-theme=e') ? 'selected="selected"' : ''}>노랑</option>
		                                        <option value="attr:data-content-theme=f" ${(xml.component[compContentColorName] == 'attr:data-content-theme=f') ? 'selected="selected"' : ''}>빨강</option>
		                                        <option value="attr:data-content-theme=g" ${(xml.component[compContentColorName] == 'attr:data-content-theme=g') ? 'selected="selected"' : ''}>초록</option>        
	                                           </select>
	                                      	</div>
	                                    </li>
	                                    <li>
	                                      	...
	                                      	<div class="gen-wid2">
	                                      	   <c:set var="compIconposName">compIconpos_${compIndex}</c:set>
	                                           <select name="compIconpos_${compIndex}" data-role="none" class="gen-sele">
		                                        <option value="">선택</option>
		                                        <option value="attr:data-iconpos=top" ${(xml.component[compIconposName] == 'attr:data-iconpos=top') ? 'selected="selected"' : ''}>상</option>
		                                        <option value="attr:data-iconpos=bottom" ${(xml.component[compIconposName] == 'attr:data-iconpos=bottom') ? 'selected="selected"' : ''}>하</option>
		                                        <option value="attr:data-iconpos=left" ${(xml.component[compIconposName] == 'attr:data-iconpos=left') ? 'selected="selected"' : ''}>좌</option>
		                                        <option value="attr:data-iconpos=right" ${(xml.component[compIconposName] == 'attr:data-iconpos=right') ? 'selected="selected"' : ''}>우</option>
	                                    ...
	                                    <li>
	                                         ...
	                                         <div class="gen-wid2">
	                                            ...
	                                            <input type="radio" name="compCollapse_${compIndex}" data-role="none" value="" ${(xml.component[compCollapseName] == null || xml.component[compCollapseName] == '') ? 'checked="checked"' : ''}/>No
	                                            <input type="radio" name="compCollapse_${compIndex}" data-role="none" value="attr:data-collapsed=false"  ${(xml.component[compCollapseName] == 'attr:data-collapsed=false') ? 'checked="checked"' : ''} />Yes
					                     	</div>
	                                   	</li>	                                                                            
                                    </ul>	
		                        </div>      
