...
<html lang="kr"> 
    ...
    <body>
        ...
        <!-- dialog menu1 start -->
        <div data-role="page" id="dialogSubMenu" data-theme="a" style="-webkit-backface-visibility: hidden;">          
            <div data-role="header">
                <h1>Menu - dialog</h1> 
            </div>         
            <div data-role="content">                
                <a href="#" data-role="button">sub 1</a>
                <a href="#" data-role="button">sub 2</a>
                <a href="#" data-role="button">sub 3</a>
            </div>         
        </div> 
        <!-- dialog menu1 end -->
