...
<html lang="kr"> 
    <head>
        <title>Generate code - Dialog</title> 
								...
								<li>
                                	...
                                	<div class="gen-wid2">
									    <select name="attrEffect" data-role="none" class="gen-sele">
											...
											<option value="attr:data-transition=turn"  ${(xml.component["attrEffect"] == 'attr:data-transition=turn') ? 'selected="selected"' : ''}>turn</option>
											<option value="attr:data-transition=flow"  ${(xml.component["attrEffect"] == 'attr:data-transition=flow') ? 'selected="selected"' : ''}>flow</option>
											<option value="attr:data-transition=slidefade"  ${(xml.component["attrEffect"] == 'attr:data-transition=slidefade') ? 'selected="selected"' : ''}>slidefade</option>
	                                    </select>
                                    </div>
								</li>
							</ul>
