                            ...
                            <ul class="c-attr">
                               <li>
	                            ...
	                            <li>
	                                ...
	                                <div class="gen-wid2">
	                                    <input type="radio" name="linkType" data-role="none" value="" ${(xml.component["linkType"] == null || xml.component["linkType"] == '') ? 'checked="checked"' : ''} />Read Only
	                                    <input type="radio" name="linkType" data-role="none" value="list" ${(xml.component["linkType"] == 'list') ? 'checked="checked"' : ''} />Link List                 
	                                </div>
	                            </li>                            
	                        </ul>    
                        </div>                      
