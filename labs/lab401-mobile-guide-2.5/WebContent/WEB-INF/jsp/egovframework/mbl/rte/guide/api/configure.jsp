                ...
                <div class="content-primary">
                    ...
                    <div class="egov-deth1">
                        ...
                        <dl class="egov-deth3">
                            ...
                            <dt>loadingMessageTextVisible (boolean, default: false):</dt>
                            <dd>로딩 메시지가 표시될 때 텍스트 표시 여부를 설정한다. loading error의 경우에는 항상 보여진다.</dd>
                            
                            <dt>loadingMessageTheme (string, default: "a"):</dt>
                            <dd>text가 보여질 때, loading message box의 색상을 지정한다.</dd>
                            
                            <dt>pageLoadErrorMessage (string, default: "Error Loading Page"):</dt>
                            <dd>Ajax 방식의 페이지이동에서 페이지 로드를 실패 했을 경우 나타나는 메시지를 변경한다.</dd>
                            
                            <dt>pageLoadErrorMessageTheme (string, default: "e"):</dt>
                            <dd>error message box가 사용될 때의 색상을 지정한다.</dd>
