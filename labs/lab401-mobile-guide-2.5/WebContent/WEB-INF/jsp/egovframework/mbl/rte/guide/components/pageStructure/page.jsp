            ...
            <div data-role="content" data-theme="d">
                ...
                <div class="content-primary">
					...
					<div class="egov-Dsclaimer">
						<h2>유의사항</h2>
						<p>각 브라우저 마다 history를 관리 하는 방식(pushstate)이 상이 하기 때문에 이를 공통적으로 지원해주기 위하여 history.js를 import하여 사용할 것을 권고한다.
						<br>(안드로이드 2.3 브라우저에서는 Iframe 내에 생성된 컴포넌트 조작 시 페이지 이동이 정상적이지 않은 경우가 발생함.)</p>
						<h3>history.js를 import함으로서 기기내 브라우져의 back 및 forword button의 기능이 정상동작한다.</h3>
	                    <div class="btnDsc"><a href="<c:url value="/js/egovframework/mbl/cmm/jquery.history.js"/>" data-role="none" data-ajax="false">
	                    <span class="btnViewSample" id="exampleView">history.js 다운로드</span></a></div>						
						
						<div id = "example">
							<div class="egov-Example">
								<ul class="link">
									<li><strong>jquery.mobile-1.1.1.js 위에 선언</strong></li>
									<li>&lt;!-- History.js --&gt;<li>
									<li>&lt;script type="text/javascript" src="/js/egovframework/mbl/cmm/jquery.history.js"&gt;&lt;/script&gt;<li> 
								</ul>
							</div>						
							<div class="egov-Example">
								<ul class="link">
									<li>pushstate 지원 브라우져 : Chrome(21.0), Firefox(15.0), Opera(12.0), Safari(5.1)</li>
									<li> - 이하버젼 브라우져는 history.js를 각 페이지에 import하여 사용</li>
									<li><strong>※향후 브라우져가 pushstate를 지원할 시 해당 스크립트 삭제 가능</strong></li>
								</ul>
							</div>
						</div>								
					</div>
                    ...
                    <div class="egov-deth1">
                        ...
                        <div class="egov-deth2">
                            <ul class="link">
                                ...
                                <li class="egov-txtIn2"><strong>&lt;link rel="stylesheet" href="/css/egovframework/mbl/cmm/jquery.mobile-1.1.1.css"/&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;link rel="stylesheet" href="/css/egovframework/mbl/cmm/EgovMobile-1.1.1.css" /&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;script src="/js/egovframework/mbl/cmm/jquery-1.7.1.min.js"&gt;&lt;/script&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;script src="/js/egovframework/mbl/cmm/jquery.mobile-1.1.1.js"&gt;&lt;/script&gt;</strong></li>
                                <li class="egov-txtIn2"><strong>&lt;script src="/js/egovframework/mbl/cmm/EgovMobile-1.1.1.js"&gt;&lt;/script&gt;</strong></li>
                                <li class="egov-txtIn1">&lt;/head&gt;</li>
                    ...
                    <div class="egov-deth1">
                        ...
                        <div class="egov-deth2">
                            <ul class="link">
                                <li><strong>&lt; mobileinit에 선언 할 경우&gt;</strong></li>
                    ...
                    <div class="egov-deth1">
                        ...
                        <div class="egov-deth2">
                            <ul class="link">
                                <li><strong>&lt; mobileinit에 선언&gt;</strong></li>
