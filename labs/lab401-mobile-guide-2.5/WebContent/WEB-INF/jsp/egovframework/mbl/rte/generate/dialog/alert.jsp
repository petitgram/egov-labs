...
<html lang="kr"> 
    <head>
        <title>Generate code - Alert</title> 
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Dialog <span class="sub">- Alert</span></h1>
					</div>					
					<form method="post">
						...
						<div class="gen-grid">
							<ul class="c-attr">
								...
								<li>
                                	...
                                	<div class="gen-wid2">
                                    <input type="text" name="etcHeader" value="<c:out value='${xml.component["etcHeader"]}' default="Alert" />" data-role="none" class="gen-sele" />
									</div>
								</li>
								<li>
									<div class="gen-wid1"><strong>소제목</strong></div>
                                	<div class="gen-wid2">
										<input type="text" name="etcContent"  value="<c:out value='${xml.component["etcContent"]}' default="Alert" />" data-role="none" class="gen-sele" />
									</div>
								</li>
							</ul>						
                           </div>
