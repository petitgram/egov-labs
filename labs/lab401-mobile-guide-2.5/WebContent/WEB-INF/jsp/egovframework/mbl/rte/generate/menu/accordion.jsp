    ...
    <head>
        ...
        function changeType(componentId) {
		 ...
		 function changeTab() {
			 ...
			 f.action = "<c:url value="/generate/menu/accordion.do"/>";
			 f.target="_self";
			 f.submit();
		 }
		 ...
		 function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/menu/accordionGen.do"/>";
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Menu <span class="sub">- Accordion</span></h1>
					</div>
                    ...
                    <div class="gen-Group">
                        <div class="gen-grid">
                            <ul class="c-attr">
                                ...
                                <li>
                                	<div class="gen-wid1"><strong>메뉴 수</strong></div>
                                   	<div class="gen-wid2">
                        ...
                        <div id="tabs">                     
                            ...
                            <div id="tabs-${compIndex}" class="gen-cont">
                                <div class="gen-grid">
                                    <ul class="c-attr">
                                        <li>
                                        	<div class="gen-wid1"><strong>상위메뉴  <c:out value="${compIndex}" /></strong></div>
		                                   	<div class="gen-wid2">
		                                        <c:set var="compTitleName">compTitle_${compIndex}</c:set>
                                            	<input type="text" name="compTitle_${compIndex}" value="<c:out value='${xml.component[compTitleName]}' default="Menu ${compIndex}" />" data-role="none" class="gen-sele" />
		                                   	</div>
                                        </li>
                                        <li>
                                        	<div class="gen-wid1"><strong>하위메뉴 <c:out value="${compIndex}" />-1</strong></div>
                                        	<div class="gen-wid2">
                                        		<c:set var="compInputText">compInputText_${compIndex}_1</c:set>
                                            	<input type="text" name="compInputText_${compIndex}_1" value="<c:out value="${xml.component[compInputText]}" default="subMenu ${compIndex}_1" />" data-role="none" class="gen-sele" />
                                        	</div>
                                        </li>
                                        <li>
                                        	<div class="gen-wid1"><strong>하위메뉴 <c:out value="${compIndex}" />-2</strong></div>
                                        	<div class="gen-wid2">
                                        		<c:set var="compInputText">compInputText_${compIndex}_2</c:set>
                                            	<input type="text" name="compInputText_${compIndex}_2" value="<c:out value="${xml.component[compInputText]}" default="subMenu ${compIndex}_2" />" data-role="none" class="gen-sele" />
                                        	</div>
                                        </li>
                                        <li>
                                        	<div class="gen-wid1"><strong>하위메뉴 <c:out value="${compIndex}" />-3</strong></div>
                                        	<div class="gen-wid2">
                                        		<c:set var="compInputText">compInputText_${compIndex}_3</c:set>
                                            	<input type="text" name="compInputText_${compIndex}_3" value="<c:out value="${xml.component[compInputText]}" default="subMenu ${compIndex}_3" />" data-role="none" class="gen-sele" />
                                        	</div>
                                        </li>
                                    </ul>
                                </div>
