	        		...
	        		<div class="egov-deth1">
						...
						<div class="egov-deth2">
                            <div data-role="fieldcontain">
	                            ...
	                            <input name="mydate" id="andate" type="date" data-role="datebox"  data-options='{"mode": "datebox" ,"themeHeader": "<%= dataTheme %>" ,"themeButton": "<%= dataTheme %>"}'>
                            </div>
                            <div data-role="fieldcontain">
	                            <label for="caldate">달력 형태</label>
	                            <input name="mydate" id="caldate" type="date" data-role="datebox" data-options='{"mode": "calbox" , "themeHeader": "<%= dataTheme %>" ,"themeDate": "<%= dataTheme %>"}' >
                            </div>
                            <div data-role="fieldcontain">
	                            <label for="filpdate">Flip 형태</label>
	                            <input name="mydate" id="filpdate" type="date" data-role="datebox" data-options='{"mode": "flipbox" , "themeHeader": "<%= dataTheme %>" ,"themeDate": "<%= dataTheme %>"}' >
                            </div>						
							<ul class="link">
	                            <li>&lt;div data-role="fieldcontain"></li>
	                            <li class="egov-txtIn1">&lt;label for="andate">안드로이드 형태&lt;/label></li>
	                            <li class="egov-txtIn1">&lt;input name="mydate" id="andate" type="date" data-role="datebox"  data-options='{"mode": "datebox" ,"themeHeader": "<%= dataTheme %>" ,"themeButton": "<%= dataTheme %>"}'></li>
	                            <li>&lt;/div></li>
	                            <li>&lt;div data-role="fieldcontain"></li>
	                            <li class="egov-txtIn1">&lt;label for="caldate">달력 형태&lt;/label></li>
	                            <li class="egov-txtIn1">&lt;input name="mydate" id="caldate" type="date" data-role="datebox"  data-options='{"mode": "calbox" , "themeHeader": "<%= dataTheme %>" ,"themeDate": "<%= dataTheme %>"}'></li>
	                            <li>&lt;/div></li>
	                            <li>&lt;div data-role="fieldcontain"></li>
	                            <li class="egov-txtIn1">&lt;label for="flipdate">Flip 형태&lt;/label></li>
	                            <li class="egov-txtIn1">&lt;input name="mydate" id="flipdate" type="date" data-role="datebox"  data-options='{"mode": "flipbox" , "themeHeader": "<%= dataTheme %>" ,"themeDate": "<%= dataTheme %>"}'></li>
	                            <li>&lt;/div></li>                                                            							
							</ul>
						</div>
