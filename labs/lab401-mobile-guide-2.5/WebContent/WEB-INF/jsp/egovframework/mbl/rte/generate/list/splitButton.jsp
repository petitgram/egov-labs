...
<html lang="kr">
    <head>
        ...
        function changeTab() {
            ...
            f.action="<c:url value="/generate/list/splitButton.do"/>";
            f.target="_self";
        ...
        function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/list/splitButtonGen.do"/>";
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Table / List View <span class="sub">- Split Button</span></h1>
					</div>
                               ...
                               <li>
                                    ...
                                    <div class="gen-wid2">
	                                    <select name="compType" data-role="none" class="gen-sele" onChange="javascript:changeType(this.value);">
	                                        ...
	                                        <option value="splitButton" selected="selected">Split Button</option>
	                            ...
	                            <li>
	                                <div class="gen-wid1"><strong>Split ICon</strong></div>
	                                <div class="gen-wid2">
	                                    <select name="attrIcon" data-role="none" class="gen-sele">
		                                    <option value="attr:data-split-icon=arrow-l" ${(xml.component["attrIcon"] == 'attr:data-split-icon=arrow-l' ) ? 'selected="selected"' : ''}>arrow-left</option>
		                                    <option value="attr:data-split-icon=arrow-r" ${(xml.component["attrIcon"] == 'attr:data-split-icon=arrow-r' ) ? 'selected="selected"' : ''}>arrow-right</option>
		                                    <option value="attr:data-split-icon=arrow-u" ${(xml.component["attrIcon"] == 'attr:data-split-icon=arrow-u' ) ? 'selected="selected"' : ''}>arrow-up</option>
		                                    <option value="attr:data-split-icon=arrow-d" ${(xml.component["attrIcon"] == 'attr:data-split-icon=arrow-d' ) ? 'selected="selected"' : ''}>arrow-down</option>
		                                    <option value="attr:data-split-icon=delete" ${(xml.component["attrIcon"] == 'attr:data-split-icon=delete' ) ? 'selected="selected"' : ''}>delete</option>
		                                    <option value="attr:data-split-icon=plus" ${(xml.component["attrIcon"] == 'attr:data-split-icon=plus' ) ? 'selected="selected"' : ''}>plus</option>
		                                    <option value="attr:data-split-icon=minus" ${(xml.component["attrIcon"] == 'attr:data-split-icon=minus' ) ? 'selected="selected"' : ''}>minus</option>
		                                    <option value="attr:data-split-icon=check" ${(xml.component["attrIcon"] == 'attr:data-split-icon=check' ) ? 'selected="selected"' : ''}>check</option>
		                                    <option value="attr:data-split-icon=gear" ${(xml.component["attrIcon"] == 'attr:data-split-icon=gear' ) ? 'selected="selected"' : ''}>gear</option>
		                                    <option value="attr:data-split-icon=refresh" ${(xml.component["attrIcon"] == 'attr:data-split-icon=refresh' ) ? 'selected="selected"' : ''}>refresh</option>
		                                    <option value="attr:data-split-icon=forward" ${(xml.component["attrIcon"] == 'attr:data-split-icon=forward' ) ? 'selected="selected"' : ''}>forward</option>
		                                    <option value="attr:data-split-icon=back" ${(xml.component["attrIcon"] == 'attr:data-split-icon=back' ) ? 'selected="selected"' : ''}>back</option>
		                                    <option value="attr:data-split-icon=grid" ${(xml.component["attrIcon"] == 'attr:data-split-icon=grid' ) ? 'selected="selected"' : ''}>grid</option>
		                                    <option value="attr:data-split-icon=star" ${(xml.component["attrIcon"] == 'attr:data-split-icon=star' ) ? 'selected="selected"' : ''}>star</option>
		                                    <option value="attr:data-split-icon=alert" ${(xml.component["attrIcon"] == 'attr:data-split-icon=alert' ) ? 'selected="selected"' : ''}>alert</option>
		                                    <option value="attr:data-split-icon=info" ${(xml.component["attrIcon"] == 'attr:data-split-icon=info' ) ? 'selected="selected"' : ''}>info</option>
		                                    <option value="attr:data-split-icon=search" ${(xml.component["attrIcon"] == 'attr:data-split-icon=search' ) ? 'selected="selected"' : ''}>search</option>
		                                    <option value="attr:data-split-icon=home" ${(xml.component["attrIcon"] == 'attr:data-split-icon=home' ) ? 'selected="selected"' : ''}>home</option>
		                                    <option value="attr:data-split-icon=phone" ${(xml.component["attrIcon"] == 'attr:data-split-icon=phone' ) ? 'selected="selected"' : ''}>phone</option>
		                                    <option value="attr:data-split-icon=mail" ${(xml.component["attrIcon"] == 'attr:data-split-icon=mail' ) ? 'selected="selected"' : ''}>mail</option>
		                                    <option value="attr:data-split-icon=gps" ${(xml.component["attrIcon"] == 'attr:data-split-icon=gps' ) ? 'selected="selected"' : ''}>gps</option>
		                                    <option value="attr:data-split-icon=audio" ${(xml.component["attrIcon"] == 'attr:data-split-icon=audio' ) ? 'selected="selected"' : ''}>audio</option>
		                                    <option value="attr:data-split-icon=camera" ${(xml.component["attrIcon"] == 'attr:data-split-icon=camera' ) ? 'selected="selected"' : ''}>camera</option>
		                                    <option value="attr:data-split-icon=file" ${(xml.component["attrIcon"] == 'attr:data-split-icon=file' ) ? 'selected="selected"' : ''}>file</option>
		                                    <option value="attr:data-split-icon=mic" ${(xml.component["attrIcon"] == 'attr:data-split-icon=mic' ) ? 'selected="selected"' : ''}>mic</option>
		                                    <option value="attr:data-split-icon=explorer" ${(xml.component["attrIcon"] == 'attr:data-split-icon=explorer' ) ? 'selected="selected"' : ''}>explorer</option>
	                                    </select>                              
	                                </div>
	                            </li>                            
	                        </ul>
                        ...
                        <div id="tabs">                     
                            ...
                            <div id="tabs-${compIndex}" class="gen-cont">
                                <div class="gen-grid">
                                    <ul class="c-attr">
                                        <li>
                                            <div class="gen-wid1"><strong>제목</strong></div>
                                            <div class="gen-wid2">  
	                                            <c:set var="compTextName">compText_${compIndex}</c:set>
	                                            <input type="text" name="compText_${compIndex}" value="<c:out value='${xml.component[compTextName]}' default="SplitButton ${compIndex}" />" data-role="none" class="gen-sele" />
	                                        </div>                                            
                                        </li>
                                        <li>
                                            <div class="gen-wid1"><strong>버튼 툴팁</strong></div>
	                                        <div class="gen-wid2">  
	                                            <c:set var="compToolTipName">compToolTip_${compIndex}</c:set>
	                                            <input type="text" name="compToolTip_${compIndex}" value="<c:out value='${xml.component[compToolTipName]}' default="toolTip ${compIndex}" />" data-role="none" class="gen-sele" />
	                                        </div>
                                        </li>
                                    </ul>                                    
                                </div>      
