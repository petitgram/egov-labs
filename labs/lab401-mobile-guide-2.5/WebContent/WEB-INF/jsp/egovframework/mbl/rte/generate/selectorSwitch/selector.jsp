		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
                            ...
                            <ul class="c-attr">
	                            <li>
	                                ...
	                                <div class="gen-wid2">
	                                    ...
	                                    <input type="radio" name="isGroup" onchange="javascript:changeGroup();" value="" data-role="none"  ${(isGroup == null || isGroup == '') ? 'checked="checked"' : ''}>비그룹
	                                    <input type="radio" name="isGroup" onchange="javascript:changeGroup();" value="Y" data-role="none" ${(isGroup == 'Y') ? 'checked="checked"' : ''} >그룹                                                                
	                                </div>
	                            </li>
	                            <c:if test="${isGroup == 'Y'}">
	                            <li>
                                ...
                                <li>
                                    ...
                                    <div class="gen-wid2">
	                                    <input type="radio" name="attrCompShape" data-role="none" value="" ${(xml.component["attrCompShape"] == null || xml.component["attrCompShape"] == '') ? 'checked="checked"' : ''} />둥근 형(radius: 1em)
	                                    <input type="radio" name="attrCompShape" data-role="none" value="attr:data-corners=false" ${(xml.component["attrCompShape"] == 'attr:data-corners=false') ? 'checked="checked"' : ''} />사각형(radius: 0em)                                                                
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="gen-wid2">
	                                    <input type="radio" name="attrDataInline" data-role="none" value="" ${(xml.component["attrDataInline"] == null || xml.component["attrDataInline"] == '') ? 'checked="checked"' : ''} />화면에 맞게
	                                    <input type="radio" name="attrDataInline" data-role="none" value="attr:data-inline=true" ${(xml.component["attrDataInline"] == 'attr:data-inline=true') ? 'checked="checked"' : ''} />텍스트에 맞게                                                                
                                    </div>
                                </li>
                                <li>
                                    <div class="gen-wid1"><strong>Shadow 효과</strong></div>
                                    <div class="gen-wid2">
                                        <input type="radio" name="attrDataShadow" data-role="none" value="" ${(xml.component["attrDataShadow"] == null || xml.component["attrDataShadow"] == '') ? 'checked="checked"' : ''} />Shadow 적용
                                        <input type="radio" name="attrDataShadow" data-role="none" value="attr:data-shadow=false" ${(xml.component["attrDataShadow"] == 'attr:data-shadow=false') ? 'checked="checked"' : ''} />Shadow 제거                                                                
                                    </div>
                                </li>                                                                                             								
								...
								<li>
									...
									<div class="gen-wid2">
									    <c:set var="attrEffect">${(param.changeStatus == 'change') ? param.attrEffect : xml.component["attrEffect"]}</c:set>
								     	<input type="radio" name="attrEffect" value="" data-role="none" ${(attrEffect == null || attrEffect == '') ? 'checked="checked"' : ''} onchange="javascript:generateSelect();"/>리스트 
										<input type="radio" name="attrEffect" value="attr:data-native-menu=false" data-role="none" ${(attrEffect == 'attr:data-native-menu=false') ? 'checked="checked"' : ''} onchange="javascript:generateSelect();"/>팝업
									</div>
								</li>                            							
								<li id="multiple" ${(attrEffect != 'attr:data-native-menu=false') ? 'style="display:none"' : ''}>
									...
									<div class="gen-wid2">
										...
										<input type="radio" name="attrFunction" value="" data-role="none" ${(attrFunction == null || attrFunction == '') ? 'checked="checked"' : ''}/>단일선택 
										<input type="radio" name="attrFunction" value="attr:multiple=multiple" data-role="none" ${(attrFunction == 'attr:multiple=multiple') ? 'checked="checked"' : ''}/>다중선택
									</div>
								</li>  	
							</ul>							  							                            																															
						</div>
					...
					브라우저 사파리 4.3에서는 지원하지 않고 있으며, 사파리 5에서는 지원하고 있습니다.</p>  
