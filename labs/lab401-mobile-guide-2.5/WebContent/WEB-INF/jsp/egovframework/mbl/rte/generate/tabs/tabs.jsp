                            ...
                            <ul class="c-attr" id="groupInfo">
                                ...
                                <li>
                                	<div class="gen-wid1"><strong>형태</strong></div>
			                     	<div class="gen-wid2">
			                     		<input type="radio" name="cssShape" data-role="none" value="" ${(xml.component["cssShape"] == null || xml.component["cssShape"] == '') ? 'checked="checked"' : ''} />Normal tab(radius: 0em)
                                    	<input type="radio" name="cssShape" data-role="none" value="Y" ${(xml.component["cssShape"] == 'Y' ) ? 'checked="checked"' : ''} />Round tab(radius: 0.250em)     
			                     	</div>
                                </li>
                                <li>
                                  	<div class="gen-wid1"><strong>아이콘 위치</strong></div>
                                  	<div class="gen-wid2">
                                  		<input type="radio" name="iconPos" data-role="none" value="" checked />미지정
                                      	<input type="radio" name="iconPos" data-role="none" value="data-iconpos=*top*" />상
                                      	<input type="radio" name="iconPos" data-role="none" value="data-iconpos=*bottom*" />하
                                      	<input type="radio" name="iconPos" data-role="none" value="data-iconpos=*left*" />좌
                                      	<input type="radio" name="iconPos" data-role="none" value="data-iconpos=*right*" />우
                                  	</div>
                                </li>
                            </ul>        
                        </div>      
                                        	...
                                        	<div class="gen-wid1"><strong>Icon</strong></div>
					                     	<div class="gen-wid2">
	                                            ...
	                                            <select name="compIcon_${compIndex}" data-role="none" class="gen-sele">
	                                                ...
	                                                <option value="attr:data-icon=gps" ${(xml.component[compIconName] == 'attr:data-icon=gps' ) ? 'selected="selected"' : ''}>gps</option>
	                                                <option value="attr:data-icon=audio" ${(xml.component[compIconName] == 'attr:data-icon=audio' ) ? 'selected="selected"' : ''}>audio</option>
	                                                <option value="attr:data-icon=camera" ${(xml.component[compIconName] == 'attr:data-icon=camera' ) ? 'selected="selected"' : ''}>camera</option>
	                                                <option value="attr:data-icon=file" ${(xml.component[compIconName] == 'attr:data-icon=file' ) ? 'selected="selected"' : ''}>file</option>
	                                                <option value="attr:data-icon=mic" ${(xml.component[compIconName] == 'attr:data-icon=mic' ) ? 'selected="selected"' : ''}>mic</option>
	                                                <option value="attr:data-icon=explorer" ${(xml.component[compIconName] == 'attr:data-icon=explorer' ) ? 'selected="selected"' : ''}>explorer</option>
	                                            </select>
					                     	</div>
                                        </li>
                                        <li>
                                            ...
                                            <input type="radio" name="compActive_${compIndex}" data-role="none" value="" ${(xml.component[compActiveName] == null || xml.component[compActiveName] == '') ? 'checked="checked"' : ''}/>No
                                            <input type="radio" name="compActive_${compIndex}" data-role="none" value="css:ui-btn-active"  ${(xml.component[compActiveName] == 'css:ui-btn-active') ? 'checked="checked"' : ''} />Yes
					                     	</div>
                                        </li>
                                    </ul>                                                                          
                                </div>      
