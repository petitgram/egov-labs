			...
			$(function() {
			 ...
			 $(function() {
				 $("#mode2").change(function() {
					...
					if($("#mode2 option:selected").val() == "mode:datebox") {
						attr = "themeButton";
					}
					else {
						attr = "themeDate";						
                        ...
                        <div class="gen-grid">
                            <ul class="c-attr">
                                <li>
									...
									<div class="gen-wid2">
										<select name="etcOptionsMode2" id="mode2" data-role="none" class="gen-sele">
										    <option value="mode:datebox" >안드로이드</option>
										    <option value="mode:calbox" >달력</option>
										    <option value="mode:flipbox" >Flip Picker</option>
										</select>
									</div>
							    </li>
                                <li>
                                ...
                                <li>
								    ...
								    <div class="gen-wid2">
										<select id="etcOptionsSub" name="etcOptionsSub" data-role="none" class="gen-sele">
	                                        <option value="">선택</option>
