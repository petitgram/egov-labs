...
<%--
  Class Name : searchFilterBar.jsp
...
<html lang="kr"> 
    <head>
        ...
        function changeTab() {
            ...
            f.action="<c:url value="/generate/list/searchFilterBar.do"/>";
            f.target="_self";
        ...
        function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/list/searchFilterBarGen.do"/>";
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Table / List View <span class="sub">- Search Filter Bar</span></h1>
					</div>			
					<form method="post">		
                               ...
                               <li>
                                    ...
                                    <div class="gen-wid2">
	                                    <select name="compType" data-role="none" class="gen-sele" onChange="javascript:changeType(this.value);">
	                                        ...
	                                        <option value="searchFilterBar" selected="selected">Search Filter Bar</option>
                                    ...
                                    <ul class="c-attr">
                                        <li>
                                            ...
                                            <div class="gen-wid2"> 
                                                ...
                                                <input type="text" name="compText_${compIndex}" value="<c:out value='${xml.component[compTextName]}' default="SearchFilter ${compIndex}" />" data-role="none" class="gen-sele" />
                                            </div>
                                        </li>
                                    </ul>
                                </div>      
