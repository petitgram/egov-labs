...
<html lang="kr"> 
    <head>
        <title>Generate code - switch</title> 
        ...
        <script>
		 ...
		 function changeTab() {
			 ...
			 f.action="<c:url value="/generate/selectorSwitch/switch.do"/>";
			 f.target="_self";
			 f.submit();
		 }
		 ...
		 function generate(status) {
             var f = document.forms[0];
             f.action="<c:url value="/generate/selectorSwitch/switchGen.do"/>";
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Selector / Switch <span class="sub">- Switch</span></h1>
					</div>
                    ...
                    <div class="gen-Group">
                        <div class="gen-grid">
                            <ul class="c-attr">
                                <li>
                                    <div class="gen-wid1"><strong>원형 색상</strong></div>
								    <div class="gen-wid2">
								...
								<li>
                                    <div class="gen-wid1"><strong>트랙 색상</strong></div>
								    <div class="gen-wid2">
										<select name="attrTrackTheme" data-role="none" class="gen-sele">
											<option value="">선택</option>
	                                        <option value="attr:data-track-theme=a" ${(xml.component["attrTrackTheme"] == 'attr:data-track-theme=a') ? 'selected="selected"' : ''}>검정</option>
	                                        <option value="attr:data-track-theme=b" ${(xml.component["attrTrackTheme"] == 'attr:data-track-theme=b') ? 'selected="selected"' : ''}>파랑</option>
	                                        <option value="attr:data-track-theme=c" ${(xml.component["attrTrackTheme"] == 'attr:data-track-theme=c') ? 'selected="selected"' : ''}>회색</option>
	                                        <option value="attr:data-track-theme=d" ${(xml.component["attrTrackTheme"] == 'attr:data-track-theme=d') ? 'selected="selected"' : ''}>흰색</option>
	                                        <option value="attr:data-track-theme=e" ${(xml.component["attrTrackTheme"] == 'attr:data-track-theme=e') ? 'selected="selected"' : ''}>노랑</option>
	                                        <option value="attr:data-track-theme=f" ${(xml.component["attrTrackTheme"] == 'attr:data-track-theme=f') ? 'selected="selected"' : ''}>빨강</option>
	                                        <option value="attr:data-track-theme=g" ${(xml.component["attrTrackTheme"] == 'attr:data-track-theme=g') ? 'selected="selected"' : ''}>초록</option>										        
										</select>  
								    </div>
								</li>
							</ul>																							
