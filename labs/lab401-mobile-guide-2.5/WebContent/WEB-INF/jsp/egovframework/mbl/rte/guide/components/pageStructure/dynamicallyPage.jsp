		...
		<div data-role="page" class="type-index">
			...
			<div data-role="content" data-theme="d">
				...
				<div class="content-primary">
	        		...
	        		<div class="egov-deth1">
						<h2>2. JSON으로 형성된 값을 받을 html을 body부분에 선언한다.</h2>
						<div class="egov-deth2">
							<ul class="link">
	        		...
	        		<div class="egov-deth1">
						...
						<div class="egov-deth2">
							<div data-role="controlgroup">
								<ul class="link">
									<li><a href="<c:url value="/guide/components/pageStructure/json/jsonInternal.do"/>" data-role="button" data-ajax="false">내부링크 Dynamic Page Example</a><li>
									<li><a href="<c:url value="/guide/components/pageStructure/json/jsonExternal.do"/>" data-role="button" data-ajax="false">외부링크 Dynamic Page Example</a><li>
						 		</ul>
					 		</div>
					 	</div>					   					   
				    </div>
