...
<html lang="kr"> 
    <head>
        ...
        <!-- <link rel="stylesheet" href="<c:url value="/css/egovframework/mbl/cmm/jquery.mobile.theme-1.1.0.css" />" />  -->
                    ...
                    <div class="egov-deth1">
                        ...
                        <div class="egov-deth2">                            
                            <ul class="link">
						        ...
						        <li>&lt;/script&gt;</li>        
						        <li>&lt;script type="text/javascript" src="/js/egovframework/mbl/cmm/jquery.mobile-1.1.1.js"&gt;&lt;/script&gt;</li>
                            </ul>
                        </div>
                        <% } %>
