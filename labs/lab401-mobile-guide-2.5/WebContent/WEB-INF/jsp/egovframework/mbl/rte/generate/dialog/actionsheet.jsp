...
<html lang="kr"> 
    <head>
        <title>Generate code - ActionSheet</title> 
    ...
    <body>
		...
		<div data-role="page">
			...
			<div data-role="content" data-theme="d">
					   ...
					   <c:set var="compCount"><c:out value="${(param.compCount == null) ? 1 : param.compCount}" /></c:set>			
				<!-- content-primary start -->
				<div class="content-primary">
					<div class="egov-tit">
						<h1>Dialog <span class="sub">- ActionSheet</span></h1>
					</div>					
					<form method="post">	
								...
								<li>
                                	...
                                	<div class="gen-wid2">
	                                    <select name="compType" id="compType" data-role="none" class="gen-sele" onchange="javascript:changeTab();">
											...
											<option value="ActionSheet" selected>ActionSheet</option>
					...
					<div class="gen-Group">
						<div class="gen-grid">
							<ul class="c-attr">
								<li>
				                    <div class="gen-wid1"><strong>선택버튼 수</strong></div>
                                	<div class="gen-wid2">
		                                <select name="compCount" data-role="none" class="gen-sele" onChange="javascript:changeTab();">
	                                        <c:forEach var="x" begin="1" end="5">
	                                        <option value="<c:out value="${x}" />" <c:if test="${compCount == x}">selected</c:if>><c:out value="${x}" /></option>
	                                        </c:forEach>
	                                    </select> 
	                                </div>
								</li>							
								...
								<li>
                                	...
                                	<div class="gen-wid2">
	                                    <input type="text" name="etcHeader" value="<c:out value='${xml.component["etcHeader"]}' default="ActionSheet" />" data-role="none" class="gen-sele" />
	                                </div>
								</li>
								<li>
				                    <div class="gen-wid1"><strong>소제목</strong></div>
                                	<div class="gen-wid2">
	                                    <input type="text" name="etcContent"  value="<c:out value='${xml.component["etcContent"]}' default="ActionSheet" />" data-role="none" class="gen-sele" />
	                                </div>
								</li>
							</ul>						
							...
							<div id="tabs">						
								...
								<div id="tabs-${compIndex}" class="gen-cont">
			                        <div class="gen-grid">
			                            <ul class="c-attr">
			                                <li>			                                
			                                	<div class="gen-wid1"><strong>선택버튼명</strong></div>
			                                	<div class="gen-wid2">
					                                <c:set var="compTextName">compText_${compIndex}</c:set>
	                                            <input type="text" name="compAction_${compIndex}" value="<c:out value='${xml.component[compTextName]}' default="Button ${compIndex}" />" data-role="none" class="gen-sele" /> 
				                                </div>
			                                </li>
			                            </ul>
			                        </div>      
