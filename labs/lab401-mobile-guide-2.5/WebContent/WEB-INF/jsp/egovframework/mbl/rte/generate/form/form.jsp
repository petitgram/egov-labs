...
<%--
  ...
  Modification Information
    ...
    -------------    --------    ---------------------
     ...
     2012.08.13    박지민          표준코드 Upgrade 및 1.1.1 버전 적용
                            ...
                            <ul class="c-attr">
                                <li>
                                	<div class="gen-wid1"><strong>Text</strong></div>
			                     	<div class="gen-wid2">
			                     		<input type="checkbox" name="inputText" value="text" ${(xml.component["inputText"] == 'text') ? 'checked="checked"' : ''} data-role="none" />선택           
			                     	</div>
                                </li>
                                <li>
                                	<div class="gen-wid1"><strong>Number</strong></div>
			                     	<div class="gen-wid2">
			                     		<input type="checkbox" name="inputNumber" value="number" ${(xml.component["inputNumber"] == 'number') ? 'checked="checked"' : ''}data-role="none"/>선택  
			                     	</div>
                                </li>
                                <li>
                                	<div class="gen-wid1"><strong>Email</strong></div>
			                     	<div class="gen-wid2">
			                     		<input type="checkbox" name="inputMail" value="email" ${(xml.component["inputMail"] == 'email') ? 'checked="checked"' : ''} data-role="none"/>선택  
			                     	</div>
                                </li>
                                <li>
                                	<div class="gen-wid1"><strong>Url</strong></div>
			                     	<div class="gen-wid2">
			                     		<input type="checkbox" name="inputUrl" value="url" ${(xml.component["inputUrl"] == 'url') ? 'checked="checked"' : ''} data-role="none"/>선택
			                     	</div>
                                </li>
                                <li>
                                	<div class="gen-wid1"><strong>Tel</strong></div>
			                     	<div class="gen-wid2">
			                     		<input type="checkbox" name="inputTel"  value="tel" ${(xml.component["inputTel"] == 'tel') ? 'checked="checked"' : ''} data-role="none"/>선택
			                     	</div>
                                </li>
                                <li>
                                	<div class="gen-wid1"><strong>Search</strong></div>
			                     	<div class="gen-wid2">
			                     		<input type="checkbox" name="inputSearch" value="search" ${(xml.component["inputSearch"] == 'search') ? 'checked="checked"' : ''} data-role="none"/>선택
			                     	</div>
                                </li>
                                <li>
                                	<div class="gen-wid1"><strong>Slider</strong></div>
			                     	<div class="gen-wid2">
			                     		<input type="checkbox" name="inputSlider" value="range" ${(xml.component["inputSlider"] == 'range') ? 'checked="checked"' : ''} data-role="none"/>선택  
			                     	</div>
                                </li>
                                <li>
                                	<div class="gen-wid1"><strong>Password</strong></div>
			                     	<div class="gen-wid2">
			                     		<input type="checkbox" name="inputPassword" value="password" ${(xml.component["inputPassword"] == 'password') ? 'checked="checked"' : ''} data-role="none"/>선택 
			                     	</div>
                                </li>
                                <li>
                                	<div class="gen-wid1"><strong>색상</strong></div>
			                     	<div class="gen-wid2">
			                     		<select name="attrTheme" data-role="none" class="gen-sele">
	                                       ...
	                                       <option value="attr:data-theme=b" ${(xml.component["attrTheme"] == 'attr:data-theme=b') ? 'selected="selected"' : ''}>회색</option>
	                                       <option value="attr:data-theme=c" ${(xml.component["attrTheme"] == 'attr:data-theme=c') ? 'selected="selected"' : ''}>연한 회색</option>
                                ...
                                <div class="gen-wid1"><strong>크기</strong></div>
			                     	<div class="gen-wid2">
			                     		<select name="attrMini" data-role="none" class="gen-sele">
		                                   <option value="">보통</option>
	                                       <option value="data-mini=*true*">작게</option>	                                                
	                                    </select>
			                     	</div>
                                </li>
                                <li>
                                <div class="gen-wid1"><strong>활성여부</strong></div>
			                     	<div class="gen-wid2">
			                     		<select name="attrDisabled" data-role="none" class="gen-sele">
