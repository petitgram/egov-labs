                        ...
                        <div class="gen-grid">
                            <ul class="c-attr">
								...
								<li>
									...
									<div class="gen-wid2">
	                                    <input type="radio" name="attrShape" data-role="none" value="" ${(xml.component["attrShape"] == null || xml.component["attrShape"] == '') ? 'checked="checked"' : ''} onChange="javascript:showCompType();" />버튼+아이콘
	                                    <input type="radio" name="attrShape" data-role="none" value="attr:data-iconpos=notext" ${(xml.component["attrShape"] == 'attr:data-iconpos=notext' ) ? 'checked="checked"' : ''} onChange="javascript:hideCompType();"/>아이콘(Only)                               
									</div>
								</li>
								<li id="showComptype">
